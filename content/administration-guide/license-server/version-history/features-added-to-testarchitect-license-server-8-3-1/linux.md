...
linktitle: "Linux"
description: "The following new features and improvements are introduced in TestArchitect License Server version 8.3.1 running under Linux."
weight: 2
aliases: 
    - /TA_ReleaseNotes/DITA_source/Whats_New_LS_8.3.1_Linux.html
keywords: "Release Notes 8.3.1, License Server, Linux, What is new, Linux, License Server 8.3.1, License Server 8.3.1, what is new, Linux"
---
...
## {{< expand >}} New Privacy Policy {{< permerlink >}} {#concept_what_new_8.3_Linux__section.TA_policy} 
