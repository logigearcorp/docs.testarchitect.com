...
Unlike a dedicated host-based license, a machine with a node-locked license has Universal license usage rights \([learn more](/administration-guide/license-server/managing-licenses/testarchitect-editions)\), as determined by the type of license purchased.

1.  [Assigning a node-locked license](/administration-guide/license-server/managing-licenses/node-locked-licenses/assigning-a-node-locked-license)  
Assigning a node-locked license binds that license to a machine for a given period of time.
2.  [Transferring a node-locked machine license](/administration-guide/license-server/managing-licenses/node-locked-licenses/transferring-a-node-locked-machine-license)  
