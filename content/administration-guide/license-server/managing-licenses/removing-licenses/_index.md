...
3.  Right-click the node, then select **Remove License**.
    ...
    **Fastpath:** Alternatively, click the **Remove License\(s\)** ![](/images//Images/remove_license_btn.png) button on the toolbar.

    ![](/images//Images/remove_license_context_menu.png)
    ...
    **Restriction:** License removal does not apply to host-based licenses.
    ...
    ![](/images//Images/remove_license_account.png)

    -   Re-input your password to **Remove License**.

        ![](/images//Images/confirm_pwd.png)
...
**Previous topic:**[Transferring host-based licenses](/TA_Administration/Topics/LS_TA_redirecting.html)
