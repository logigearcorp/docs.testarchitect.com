...
1.  If not already present on the machine, install the TestArchitect License Server application. \([Learn more](/administration-guide/license-server/license-server-installation-guide/).\)

2.  Start the License Server Control Panel. \([Learn more](/administration-guide/license-server/managing-the-license-server/starting-and-stopping-the-server).\)
...
-   Should you be unsuccessful in restoring your primary license server within the imposed time limit, you may contact LogiGear to request another 72-hour period of redundant license server operation. \([Learn more](/administration-guide/license-server/managing-the-license-server/unblocking-a-redundant-license-server).\)
