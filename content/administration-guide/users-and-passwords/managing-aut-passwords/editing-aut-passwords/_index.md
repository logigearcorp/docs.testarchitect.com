...
3.  In the Manage Passwords dialog box, select the password that you want to modify by clicking the **Edit password** button ![](/images//Images/Edit_password_btn.png).
