...
description: "As an administrator, you can change the password of a user. This is especially helpful if a user forgets his or her password."
weight: 5
aliases: 
    - /TA_Administration/Topics/adm_users_changing_password.html
keywords: "user administration, changing password"
---
...
4.  In the Change Password dialog box, enter and confirm the new password.
    ...
    ![](/images/TA_Help/Images/Select_pwd_dlg.png)

    A message box appears indicating that the reset was successful.

    ![](/images/TA_Help/Images/Select_pwd_confirmation.png)
