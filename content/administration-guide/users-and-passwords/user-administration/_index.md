...
## Detailed permissions of each functional group { .section}
...
1.  [Invoking the Manage Users dialog box](../../TA_Administration/Topics/adm_users_invoking_Manage_Users.md)  
...
2.  [Creating a repository user](../../TA_Administration/Topics/adm_users_creating.md)  
...
3.  [Deleting a repository user](../../TA_Administration/Topics/adm_users_deleting.md)  
As an administrator, you can delete a TestArchitect user if that user is no longer required.
4.  [Editing a user's profile](../../TA_Administration/Topics/adm_users_modifying_profile.md)  
As an administrator, you can edit the data in a repository user's profile.
5.  [Changing a repository user's password](../../TA_Administration/Topics/adm_users_changing_password.md)  
...
6.  [Setting a repository's user authentication mode](../../TA_Administration/Topics/adm_users_setting_authentication_mode.md)  
Choose the means by which users of a given repository are to be authenticated when logging in.
7.  [Assigning projects and permissions to a repository user](../../TA_Administration/Topics/adm_users_assigning_repositories.md)  
...
8.  [Assigning user permissions for a specific project](../../TA_Administration/Topics/adm_users_assigning_permissions.md)  
...
9.  [Assigning user permissions for a specific project item](../../TA_Administration/Topics/adm_users_assigning_permissions_items.md)  
...
**Next topic:**[Managing AUT passwords](../../TA_Administration/Topics/Manage_password.md)
