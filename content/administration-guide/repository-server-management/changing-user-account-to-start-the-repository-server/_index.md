...
-   **[Changing user account during installation process to start the Repository Server service](../../TA_Administration/Topics/adm_changing_OS_account_installation.md)**  
...
-   **[Changing user account via the Repository Server Control Panel dialog box to start the Repository Server service](../../TA_Administration/Topics/adm_changing_OS_account_RS_dlg.md)**  
...
**Previous topic:**[Setting Java heap size](../../TA_Administration/Topics/Repo_setting_heap_size.md)

**Next topic:**[TestArchitect Utility Server](../../TA_Administration/Topics/TA_Utility_Server.md)
