...
2.  In the dialog box, select **Tools** \> **TestArchitect Utility Server Information**.
    ...
    **Note:** The **TestArchitect Utility Server Information** command is enabled only when the repository server is [started](Starting_repository_server.md).
...
**Previous topic:**[Changing user account to start the repository server](../../TA_Administration/Topics/adm_changing_OS_account.md)

**Next topic:**[Upgrading the repository database for name change propagation](../../TA_Administration/Topics/Repo_database_upgrade.md)

**Related information**  


[Lab Manager](../../TA_Help/Topics/Lab_manager.md)

[Dashboard](../../TA_Help/Topics/Dashboard.md)
