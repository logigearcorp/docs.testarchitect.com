...
**Remember:** You must be logged in to TestArchitect Client as a member of the [administrator](User_administration.md) group to configure external tools, or create or edit test tool profiles. Administrator changes are made available to all other clients logging in to the same repository.

1.  [External Tool](../../TA_Administration/Topics/External_tool.md)  
...
2.  [LDAP Tool](../../TA_Administration/Topics/adm_LDAP_tool.md)  
...
3.  [Test Tool](../../TA_Administration/Topics/Test_tool.md)  
...
**Previous topic:**[User-defined fields](../../TA_Administration/Topics/User_defined_fields.md)

**Next topic:**[License server for TestArchitect](../../TA_Administration/Topics/LS_TA_License_server.md)
