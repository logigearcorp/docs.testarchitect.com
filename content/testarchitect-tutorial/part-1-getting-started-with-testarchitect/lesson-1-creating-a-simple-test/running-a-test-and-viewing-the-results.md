...
[Record and Playback](/user-guide/introduction-to-action-based-testing/introduction/record-and-playback)

[Playback toolbar](/user-guide/test-execution/playback-toolbar)

[Running the test](/testarchitect-tutorial/part-2-becoming-a-testarchitect-power-user/lesson-2-interfacing-with-a-gui/running-the-test)

[Viewing the test results](/testarchitect-tutorial/part-3-extending-testarchitect/lesson-8-using-an-automation-harness/working-with-the-python-harness/user-scripted-python-harness-action-that-interacts-with-gui/viewing-the-test-results)

[Viewing the test results](/testarchitect-tutorial/part-3-extending-testarchitect/lesson-8-using-an-automation-harness/working-with-the-java-harness/user-scripted-java-harness-action-that-interacts-with-gui/viewing-the-test-results)
