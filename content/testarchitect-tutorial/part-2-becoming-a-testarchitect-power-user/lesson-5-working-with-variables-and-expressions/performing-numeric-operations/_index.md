...
description: "Your action arguments may contain numeric operations, such as addition and division. Such operations can operate on both numeric literals as well as variables."
weight: 4
aliases: 
    - /TA_Tutorials/Topics/Performing_numeric_operations.html
keywords: "operations, numeric, numeric operations, expressions, report (action), expression in"
---
...
5.  Your test case should now resemble this:
    ...
    ![](/images/TA_Tutorials/Images/tut.Vars_and_Exps.Numeric_01.Test.full.png)
...
![](/images/TA_Tutorials/Images/tut.Vars_and_Exps.Numeric_01.TestFull_Results.png)
