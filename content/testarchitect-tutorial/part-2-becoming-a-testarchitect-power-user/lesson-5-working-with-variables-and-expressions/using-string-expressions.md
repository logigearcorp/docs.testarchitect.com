...
description: "How to use concatenation to manipulate text in action arguments."
weight: 2
aliases: 
    - /TA_Tutorials/Topics/Using_string_expressions.html
keywords: "expressions, strings, constants, operations, concatenation, operators, symbols, # (pound) sign, (quotation mark), quotation mark"
---
...
5.  Enter the following action lines:
    ...
    ![](/images/TA_Tutorials/Images/tut.Vars_and_Exps.Strings.Test.02.png)
...
![](/images/TA_Tutorials/Images/tut.Vars_and_Exps.Strings.Test02_Results.png)
