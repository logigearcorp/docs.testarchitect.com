...
description: "Combine numeric and string operations in single expressions, operating on both numeric and text values."
weight: 6
aliases: 
    - /TA_Tutorials/Topics/Working_with_mixed_types.html
keywords: "mixed expressions, expressions, conversion, numeric to string, operators, precedence, operator precedence"
---
...
3.  Add another report action that combines both string and numeric operations, on both types of operand:
    ...
    ![](/images/TA_Tutorials/Images/tut.Vars_and_Exps.Mixed_Expr_01.Test.png)
...
![](/images/TA_Tutorials/Images/tut.Vars_and_Exps.Mixed_Expr_01.Results.png)
