...
5.  Click **Record** on the toolbar:
    ...
    ![](/images//Images/tutActionRecorder_3.png)
...
9.  Clear the contents \(if any\) of the **Pick Up City** text box, replacing them with Miami.
    ...
    ![](/images//Images/tutActionRecorder_16.png)
...
10. Click **Stop** on the recording panel.
    ...
    ![](/images//Images/tutActionRecorder_17.png)
...
12. With your test module displayed in the TestArchitect editor, click **Execute** ![](/images//Images/TA_Tutorials/Images/btn.TAC_toolbar.Execute.png) on the toolbar.
