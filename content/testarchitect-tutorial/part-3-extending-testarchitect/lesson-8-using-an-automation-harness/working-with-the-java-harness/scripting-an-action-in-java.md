...
As outlined in the three-step procedure described earlier, \(in[Developing your own User-scripted Java harness action](/testarchitect-tutorial/part-3-extending-testarchitect/lesson-8-using-an-automation-harness/working-with-the-java-harness/developing-your-own-user-scripted-java-harness-action)\) \), this entails making the following modifications to moduleMod\_Example.java:
