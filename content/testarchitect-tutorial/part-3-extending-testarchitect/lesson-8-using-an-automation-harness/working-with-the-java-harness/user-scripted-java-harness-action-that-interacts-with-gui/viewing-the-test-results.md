...
-   [Created a test case](/testarchitect-tutorial/part-3-extending-testarchitect/lesson-8-using-an-automation-harness/working-with-the-java-harness/user-scripted-java-harness-action-that-interacts-with-gui/creating-the-test-case-and-stub-action) in TestArchitect which calls check row count, an action for counting selected rows of a table in an application,
-   [Created the Java method](/testarchitect-tutorial/part-3-extending-testarchitect/lesson-8-using-an-automation-harness/working-with-the-java-harness/user-scripted-java-harness-action-that-interacts-with-gui/scripting-a-java-based-gui-interfacing-action) action\_CheckRowCount\(\) to implement the check row count action, and [written the essential code](/testarchitect-tutorial/part-3-extending-testarchitect/lesson-8-using-an-automation-harness/working-with-the-java-harness/user-scripted-java-harness-action-that-interacts-with-gui/creating-a-new-java-code-script-module) to ensure that the execution of check row count results in control being directed to that method.
