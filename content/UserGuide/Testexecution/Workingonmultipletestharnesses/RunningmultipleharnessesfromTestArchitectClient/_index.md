...
---
# Running multiple harnesses from TestArchitect Client {#Test_exec_multiple_harnesses .task}
...
**Tip:** As for as [synchronous remote execution](Test_exec_remote_synchronous.html), a lead machine is capable of launching multiple harnesses on a deputy machine.

Perform the following steps to execute multiple harnesses from TestArchitect Client:

1.  In TestArchitect's tree explorer, locate and execute the preferred test suite/module. \([Learn more](Test_exec_test_execution.html)\)
...
2.  Continue to execute the other preferred test suites/modules one after another while other harnesses are still running.
    ...
    **Tip:** You can monitor all the running harnesses and their statuses via:
    ...
    -   [Playback toolbar](Test_exec_playback_toolbar.html)
    -   [TestArchitect Controller](Controller_management.html) dialog box.
    -   [Lab Manager](Lab_manager.html)
