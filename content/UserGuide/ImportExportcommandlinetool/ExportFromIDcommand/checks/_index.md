...
---
# Example: Exporting test modules including regular picture checks {#task_kkz_cg5_kt .task}
...
3.  Based on the given scenario, enter the following command, and then press Enter.
    ...
    ![](../Images/TA_Export_Import_tool_ExportFromID_regular_picture_check.png)
