...
---
# Running the Help command \(Import/Export tool\) {#task_r1y_vdd_1s .task}
...
3.  Enter either of the following commands, and then press Enter.
    ...
    ![](../Images/TA_Export_Import_tool_general_help_cmd.png)

    The help display for a specific command \(ImportRepository\):

    ![](../Images/TA_Export_Import_tool_specific_help_cmd.png)


**Parent topic:**[Help command \(Import/Export tool\)](../../TA_Help/Topics/ug_export_import_tool_help.html)
