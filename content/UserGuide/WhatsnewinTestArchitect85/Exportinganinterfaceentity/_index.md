...
---
# Exporting an interface entity {#Test_result_export_import .task}
...
-   **Option 1**:
    ...
    2.  In the Export Interface Entity dialog box, click ![](../Images/btn.browse-ellipsis.01.png) to choose a location to save the file \(in .ZIP format\).
...
-   **Option 2**:
    ...
    3.  In the Export Interface Entity dialog box, click ![](../Images/btn.browse-ellipsis.01.png) to choose a location to save the file \(in .ZIP format\).
