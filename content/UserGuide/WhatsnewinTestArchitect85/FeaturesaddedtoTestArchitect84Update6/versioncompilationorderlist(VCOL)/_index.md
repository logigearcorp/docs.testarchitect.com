...
---
# version compilation order list \(VCOL\) {#gl.glossary_entry_version_compilation_order .glossentry}
...
See also: [version compilation order](glossaryVersionCompilationOrder.html).
