...
---
# Summary tab {#Test_result_summaries .concept}
...
## General Information section {#section_ap1_5pz_ldb .section}

The top of the **Summary** tab lists such items as follows:

![](../Images/Test_results_summaries_general_info.01.png)
...
|**Video snapshots directory**|The location at which [screen-recording videos](ug_Screenshot_recording.md#section.Video_playback) \(taken during the automated test runs\) are stored.|
...
![](../Images/Test_results_summaries_general_info.01a.png)
...
## Test Case Summary section {#section_v2r_fqz_ldb .section}
...
![](../Images/Test_results_summaries_TC_summary_XML.png)
...
-   Click ![](../Images/Test_results_expand_detail.png), next to the test case's title, to expand and view **Step Summary** table for each test case.

## Failure/Error Summary section {#section_failure.error .section}
...
![](../Images/Test_results_summary_failure_error_summary.png)

## Known Bug Summary section {#section_known.bug .section}
...
![](../Images/Test_results_summary_known_bug_summary.png)

## Log Information tab section {#section_log.information .section}
...
![](../Images/Test_results_summary_log_info.png)

## Additional functions {#section_py3_gj4_5x .section}
...
-   Available options for a **local result**:
    ...
    ![](../Images/Result_details_tab_main_panel_local_result_XML.png)
    ...
    5.  [Add local test result to repository.](Test_result_viewing_storing.md#step_bvq_cjp_h4)
    6.  [Resolve unverified picture checks.](ug_Resolving_unverfied_picture_checks.html)
    7.  [Export test result to an HTML file.](Test_result_export_HTML.md#step_qld_qkp_h4)
    8.  [Compare to baseline.](Test_result_compare_to_baseline_results.md#step_e3l_3jp_h4)
-   Available options for a **repository result**:

    ![](../Images/Result_details_tab_main_panel_repo_result_XML.png)
    ...
    7.  [Set as baseline](Test_result_settting_baseline.md#step_an5_ljp_h4)
    8.  [Compare to baseline.](Test_result_compare_to_baseline_results.md#step_e3l_3jp_h4)
