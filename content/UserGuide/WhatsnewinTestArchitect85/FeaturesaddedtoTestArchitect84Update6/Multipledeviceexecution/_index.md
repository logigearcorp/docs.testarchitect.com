...
---
# Multiple device execution {#multiple_device_execution .task}
...
3.  In the **Controllers/Devices** frame, click **Select Controllers and Devices**.
    ...
    ![](../Images/Select_controllers_devices.png)
...
4.  In the Select Controller/Device dialog box, ensure that the IP and port number in the **Lab Manager Server** panel are correct. If not, click **Connect to other** and enter the IP and Port numbers of the Lab Manager Server.
    ...
    **Note:**
    ...
    -   The main branches under the root node are controllers \(marked with the icon ![](../Images/Controller_icon.png)\), and the subnodes of a controller are devices that physically attached to that controller.
...
**Previous topic:**[Remote test execution](../../TA_Help/Topics/Test_exec_remote.html)

**Next topic:**[Running tests with multiple remote desktop sessions](../../TA_Help/Topics/Test_exec_multiple_remote_desktop_sessions.html)
