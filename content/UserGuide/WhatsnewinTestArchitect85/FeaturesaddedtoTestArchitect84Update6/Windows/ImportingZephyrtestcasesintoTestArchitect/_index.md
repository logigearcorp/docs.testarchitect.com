...
---
# Importing Zephyr test cases into TestArchitect {#task_gpl_5l4_jp .task}
...
6.  The Confirm Overwriting dialog box appears, showing a list of test cases/ test modules that already exists in TestArchitect if any. Select the check boxes for the TestArchitect test cases / test modules that you want to overwrite with TestArchitect test cases/ test modules. Click the **OK** button.
    ...
    ![](../Images/Zephyr_import_overwrite_dlg.png)
...
![](../Images/Zephyr_import_teststeps.png)

**Note:** If you want to import a custom column from Zephyr into TestArchitect, you must first [create new column](../../TA_Administration/Topics/User_defined_fields_create.md#) in TestArchitect with the same name.
