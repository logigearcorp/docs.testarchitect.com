...
---
# Searching item content for text {#task_mhc_n4n_bw .task}
...
2.  In the dialog box, select the **Search String** tab, and enter a search string in the **Search what:** text box.
    ...
    ![](../Images/Search_dlg_search_string.png)
...
3.  Click **Search**.
    ...
    ![](../Images/Search_dlg_search_string_results.png)
...
4.  To open a listed item, double-click it.
    ...
    **Note:** Alternatively, select an item, and then click the **View** button.
    ...
    ![](../Images/Search_dlg_search_string_results_chosen.png)


**Parent topic:**[Search](../../TA_Help/Topics/Additional_features_search.html)

**Previous topic:**[Searching items in the TestArchitect explorer tree](../../TA_Help/Topics/ug_search_item.html)
