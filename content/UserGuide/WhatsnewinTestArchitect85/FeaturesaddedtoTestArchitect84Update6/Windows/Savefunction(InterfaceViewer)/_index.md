...
---
# Save function \(Interface Viewer\) {#Interface_viewer_other_functionality_save .concept}

Once the proper controls have been named in the tree, and the identifying properties have been selected, you can save the definitions to the interface entity with the **Save** ![](../Images/btn_Interface_Viewer-Save.png) button.Make sure the interface entity is checked out prior to saving the definitions to it. Saving makes permanent the mappings \(or unmappings\) you have done in your Interface Viewer session by writing the current configuration to the open interface entity, then saving the interface entity.
...
![](../Images/ug_interface_definition28.png)
