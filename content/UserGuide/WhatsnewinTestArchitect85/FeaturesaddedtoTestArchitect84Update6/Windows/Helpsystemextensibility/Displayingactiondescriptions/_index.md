...
---
# Displaying action descriptions {#Additional_feaures_help_sensitive_displaying .task}
...
2.  For each documented custom action, add an action entry to user\_defined\_help.ini along with the corresponding command, and the absolute path to the appropriate HTML page. \([Learn more](Additional_features_Help_extensibility_configuration.md#section_r2d_nlh_cl)\).
