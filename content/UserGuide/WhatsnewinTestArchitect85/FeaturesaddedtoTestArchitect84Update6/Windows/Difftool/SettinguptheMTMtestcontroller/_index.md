...
---
# Configuring and registering an MTM test controller {#task_oml_l3h_sq .task}
...
1.  Please refer to Microsoft's instructions on configuring and registering a test controller:
    ...
    ![](../Images/MTM_config_controller.png)
...
2.  Click the **Apply Settings** button.
    ...
    ![](../Images/MTM_TC_config_summary_dlg.png)
...
**Previous topic:**[Deploying and configuring a build agent for TFS-MTM integration](../../TA_Help/Topics/ug_MTM_build_agent.html)

**Next topic:**[Configuring and registering an MTM test agent](../../TA_Help/Topics/Integrate_MTM_Config_TestAgent.html)
