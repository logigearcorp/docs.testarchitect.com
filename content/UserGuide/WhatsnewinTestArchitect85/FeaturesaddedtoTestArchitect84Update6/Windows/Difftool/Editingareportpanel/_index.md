...
---
# Editing a report panel {#Dashboard_edit_report_panel .task}
...
2.  On the Dashboard, go to the Dashboard page containing the report panel you want to edit and click **Edit Panel** ![](../Images/Dashboard_edit_panel_icon.png).

3.  On the Edit Panel dialog box, change the panel settings on the **Display Settings** and **Filters** tabs as needed.

    The panel settings on the Edit Panel dialog box are the same as the settings on the Add New Panel dialog box for reports \(see [Create new indicator panel](Dashboard_create_new_report_panel.html)\) steps \#[3](Dashboard_create_new_report_panel.md#step_pde7_cy3e) through \#[4](Dashboard_create_new_report_panel.md#step_dk38_8sdf) with the following additional setting options:
