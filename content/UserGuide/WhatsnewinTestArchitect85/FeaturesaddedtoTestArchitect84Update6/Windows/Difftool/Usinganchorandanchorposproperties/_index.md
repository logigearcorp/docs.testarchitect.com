...
---
# Using anchor and anchor pos properties {#Interface_viewer_anchor_ex1 .task}
...
![](../Images/interface.anchor_pos.12a.png)
...
3.  Launch the Interface Viewer from TestArchitect \(press F7 or select **Tools** \> **Interface Viewer**from the main menu; or click the **Interface Viewer** ![](../Images/Interface_viewer_btn.png) button on the toolbar\).
...
5.  Now locate the node for the **div** element that will serve as our anchor. It's the one whose id property has the value national\_section.
    ...
    3.  Back in the UI Explorer panel, double-click the node.
        ...
        ![](../Images/interface.anchor_pos.07.png)
...
7.  In the TA Properties panel, click in the **anchor** property field once or twice until the **Browse** button appears, then click the button:
    ...
    ![](../Images/IV_tree_for_anchor_pos.05a.png)

    This launches the Anchor Selection dialog box:

    ![](../Images/IV_tree_for_anchor_pos.06a.png)
...
11. Clear any other property check boxes besides anchor and anchor pos.
    ...
    ![](../Images/IV_tree_for_anchor_pos.09a.png)
...
13. 14. Now, repeat steps [6](#step.map_link.start) through [11](#step.map_link.stop) for the other two link elements holding national headlines. Assign them both the same anchor as the first, and name them, sequentially, **link\_national\_article2\_headline** and **link\_national\_article3\_headline**.
    ...
    ![](../Images/IV_tree_for_anchor_pos.10a.png)

15. 16. Click **Save** ![](../Images/btn_Interface_Viewer-Save.png) on the Interface Viewer's toolbar to save the mappings to your interface entity:

    ![](../Images/IV_tree_for_anchor_pos.11a.png)
...
20. Enter the following action lines for the test case:
    ...
    ![](../Images/IV_tree_for_anchor_pos.12a.png)
...
**Next topic:**[Using anchor pos with dynamic identifiers](../../TA_Help/Topics/prop_anchor.example_02.html)
