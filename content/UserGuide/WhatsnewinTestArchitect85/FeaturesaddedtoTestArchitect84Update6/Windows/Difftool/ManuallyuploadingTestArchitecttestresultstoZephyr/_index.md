...
---
# Manually uploading TestArchitect test results to Zephyr {#task_zdw_skv_jp .task}
...
2.  In the Select Test Case To Upload dialog box,
    ...
    ![](../Images/Zephyr_manual_upload_results.png)
    ...
    ![](../Images/Zephyr_successful_auto_upload_results.png)
