...
---
# Executing Car Rental tests on Android device {#Car_Rental_TA_Client_Android .task}
...
5.  Click the **Execute** ![](../Images/btn.TAC_toolbar.Execute.png) button on the toolbar to start the Execute Test dialog box.
