...
---
# Prerequisites for running tests under TFS-MTM {#concept_dbc_x3c_h5 .concept}

This topic describes the requirements that must be met by the systems involved in running tests under TFS-MTM.

## Requirements for each system { .section}

## Computer hosting the TestArchitect repository server { .section}
...
## TestArchitect Client computer on which you create and configure tests { .section}
...
## Lab environment where tests run { .section}
