...
---
# Work Item Query Language - Work Item Query reference {#concept_rvt_q5g_dw .concept}
...
-   In the qualifying WHERE clause, the ID of the TFS test plan is mandatory. At a given time, only a single TFS test plan is accepted in the query session.
    ...
    **Tip:** You can find test plan ID in the following:
    ...
    -   in the [Select Location](ug_MTM_upload_result_manual.html) dialog box:
        ...
        ![](../Images/test_plan_ID.png)

    -   in the MTM Testing Center window:

        ![](../Images/test_plan_ID_MTM.png)


## Query to upload TA test results to TFS tests assigned to specific configuration { .section}
...
![](../Images/test_suite_plan_configuration_ID.png)
...
**Previous topic:**[Mapping test results between TestArchitect and Team Foundation Server](../../TA_Help/Topics/ug_MTM_mapping_result_table.html)
