...
---
# Running automated tests in Microsoft Test Manager {#task_qk3_2dg_3r .task}
...
3.  On the Run Tests page, select a test suite or an individual test you want to run.
    ...
    ![](../Images/MTM_select_test_runs.png)

4.  Select **Run** from the **Run** menu.

    ![](../Images/run_MTM_test.png)
