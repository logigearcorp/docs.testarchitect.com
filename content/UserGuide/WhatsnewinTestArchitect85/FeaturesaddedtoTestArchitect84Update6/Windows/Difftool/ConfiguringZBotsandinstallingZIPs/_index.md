...
---
# Configuring ZBots and installing ZIPs {#task_t15_fbj_jp .task}
...
1.  Install Zbot.
    ...
    2.  Follow these instructions to download and install Zbot. \([Learn more](https://zephyrdocs.atlassian.net/wiki/spaces/ZE61/pages/279412763/Installation+and+Usage+of+ZBots+on+Windows).\)
        ...
        ![](../Images/Zephyr_automated_tools.png)
...
-   Prior to [running automated tests from Zephyr](ug_Zephyr_executing_tests.html), it is required that you repeat step [5](ug_Zephyr_ZBot.md#step_start_zbot) to start the ZBot service manually.
...
**Previous topic:**[Mapping a TestArchitect project to a Zephyr project](../../TA_Help/Topics/ug_Zephyr_mapping_projects.html)
