...
---
# Creating a new indicator panel {#Dashboard_create_new_indicator_panel .task}
...
3.  On the Add New Panel dialog box, select the **Indicator** radio button as the panel **Type**, and then enter the information as requested and click **OK**.
    ...
    ![](../Images/Dashboard_add_new_indicator_panel_settings_tab.png)
    ...
    **Indicator Settings**:
    ...
    -   ![](../Images/Dashboard_add_new_indicator_panel_plus_icon.png): adds one more **From** and **Color** control pair.
    -   ![](../Images/Dashboard_add_new_indicator_panel_delete_icon.png): removes a **From** and **Color** control pair.
