...
---
# Editing a panel template {#Dashboard_edit_data_profile_dashboard .task}
...
3.  On the panel name table list, select **Edit** under the Action column of the panel name row you want to edit.
    ...
    ![](../Images/Dashboard_edit_panel_name_table.png)
