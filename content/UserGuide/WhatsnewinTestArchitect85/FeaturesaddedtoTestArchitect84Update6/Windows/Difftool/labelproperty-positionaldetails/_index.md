...
---
# label property - positional details {#Interface_def.label_property_supplement .concept}
...
## Aligned labels {#section.alignment .section}
...
:   A label is considered to be left zone-aligned with a given label-accepting control if meets all of the following criteria:
    ...
    ![](../Images/prop_label.left_zone_alignments.png)
...
:   A label is considered to be top zone-aligned with a given label-accepting control if meets all of the following criteria:
    ...
    ![](../Images/prop_label.top_zone_alignment.png)
...
:   A label is considered to be right zone-aligned with a given label-accepting control if meets all of the following criteria:
    ...
    ![](../Images/prop_label.right_zone_alignments.png)
...
![](../Images/prop_label.special_case.alignment_margin.png)

## Proximate non-aligned labels {#section.proximate_labels .section}
...
![](../Images/prop_label.left_zone_nonaligned_candidates.01.png)
...
![](../Images/prop_label.top_zone_nonaligned_candidates.png)
...
## Distance determination between label and main control {#section.distance_determination .section}
...
![](../Images/prop_label.proximity.png)
