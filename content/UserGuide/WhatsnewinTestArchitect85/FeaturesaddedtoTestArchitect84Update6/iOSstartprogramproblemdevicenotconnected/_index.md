...
---
# iOS start program problem: device not connected {#ref.faq.tshoot.ios.start_program.device_not_connected .reference}
...
**Previous topic:**[iOS start program problem: no target application](../../TA_FAQ/Topics/faq.tshoot.ios.start_program.aut_not_found.html)

**Next topic:**[iOS start program problem: missing device libraries](../../TA_FAQ/Topics/faq.tshoot.ios.start_program.missing_libraries.html)
