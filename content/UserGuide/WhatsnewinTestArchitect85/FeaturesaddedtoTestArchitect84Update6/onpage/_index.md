...
---
# Adjusting the number of truncated iterations and pagination page {#task_txg_zrc_qz .task}
...
2.  Adjust the following parameters' values as you wish.
    ...
    -   `<xsl:param name="display_Failure_Rows_Number" select="5"/>`
        ...
        **Note:** The number of rows that will be shown in the [**Failure Summary**](Test_result_details.md#li.Error_warning_failures_summary) table.
