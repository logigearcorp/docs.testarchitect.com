...
---
# Exporting repository test results to an HTML file {#task_mxy_m2y_jt .task}
...
3.  In the Save Result\(s\) To File dialog box, choose a location in which to save the HTML file.
    ...
    ![](../Images/Save_repo_results_to_html.png)
...
**Previous topic:**[Exporting local test results to an HTML file](../../TA_Help/Topics/Test_result_export_HTML.html)

**Next topic:**[Exporting test results to XML](../../TA_Help/Topics/Test_result_export_XML.html)
