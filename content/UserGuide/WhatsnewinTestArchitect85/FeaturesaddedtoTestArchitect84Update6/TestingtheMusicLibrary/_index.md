...
---
# Testing the Music Library {#Music_player_executing .task}
...
4.  Select the particular Music Library test \(for example, UI functional tests\) you want to execute and click the **Execute** ![](../Images/btn.TAC_toolbar.Execute.png) button on the toolbar.
...
**Previous topic:**[Scrum Board](../../TA_Tutorials_Sample_App/Topics/SR_Scrum_Board_def.html)
