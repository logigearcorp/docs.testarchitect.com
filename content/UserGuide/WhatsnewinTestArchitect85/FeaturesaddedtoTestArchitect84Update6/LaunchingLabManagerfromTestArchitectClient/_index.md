...
---
# Launching Lab Manager from TestArchitect Client {#Lab_manager_Launching_from_TestArchitect_Client .concept}
...
![](../Images/ug_err_utility_server_unavailable.png)
...
1.  The Repository Server Control Panel may be accessed through its icon ![](../Images/admin_RS_icn_RSrunning.png) in the Windows notification area \(generally on the right side of the Windows taskbar\), or through the Windows Start menu \(**Start** \> **All Programs** \> **TestArchitect** \> **Repository Server**\).
...
**Next topic:**[Launching Lab Manager from Dashboard](../../TA_Help/Topics/Lab_manager_Dashboard.html)
