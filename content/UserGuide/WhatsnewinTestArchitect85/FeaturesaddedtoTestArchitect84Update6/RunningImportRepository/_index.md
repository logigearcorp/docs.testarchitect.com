...
linktitle: "Running ImportRepository"
aliases: 
    - /TA_Help/Topics/ug_export_import_tool_import_repository_running.html
---
# Running ImportRepository command \(Import/Export tool\) {#task_g5n_5vk_1s .task}
...
![](../Images/TA_Export_Import_tool_ImportRepo.png)

**Parent topic:**[ImportRepository command \(Import/Export tool\)](../../TA_Help/Topics/ug_export_import_tool_import_repository.html)
