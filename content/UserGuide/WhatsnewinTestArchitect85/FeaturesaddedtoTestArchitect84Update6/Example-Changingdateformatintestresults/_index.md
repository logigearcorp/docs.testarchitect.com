...
---
# Example - Changing date format in test results {#task_o3r_x1r_qy .task}
...
![](../Images/customization_results_date_format.png)
...
5.  Open a test result in a web browser, or TestArchitect Client.
    ...
    ![](../Images/customization_results_date_format_effect.png)


**Parent topic:**[Customizing XML test results](../../TA_Help/Topics/ug_customizing_XML_report.html)

**Previous topic:**[Example - Removing the 'Result Details' tab in test results](../../TA_Help/Topics/ug_customizing_XML_report_example_1.html)

**Next topic:**[Adjusting the number of truncated iterations and pagination page](../../TA_Help/Topics/ug_modifying_truncated_iterations.html)
