...
---
# Content Assist {#concept_ymd_xql_3p .concept}
...
![](../../reuse/../TA_Help/Images/Autocomplete_actions.png)

![](../../reuse/../TA4VS_Help/Images/Autocomplete_actions.png)
...
-   In the case of [INTERFACE ENTITY](../../reuse/reuse.Creating_and_using_actions_Arg_type.md#sectiondiv.arg_type.int_ent)-type arguments \(generally, arguments named window\), Content Assist supplies the names of all interface entities of your project's *assumed* interface:
...
-   In the case of [INTERFACE ENTITY](../../reuse/reuse.Creating_and_using_actions_Arg_type.md#sectiondiv.arg_type.int_ent)-type arguments \(generally, arguments named window\), Content Assist supplies the names of all interface entities of your project.
-   Once a window or dialog is specified, [INTERFACE ELEMENT](../../reuse/reuse.Creating_and_using_actions_Arg_type.md#sectiondiv.arg_type.int_elt)-type arguments \(typically named control\), have their domains limited to the elements \(controls\) of the given interface entity.
-   [VALUE SET](../../reuse/reuse.Creating_and_using_actions_Arg_type.md#sectiondiv.arg_type.value_set)-based arguments are those for which a domain of allowable values has been explicitly specified; this set of values serves as the pre-filtered source of the Content Assist list.

![](../../reuse/../TA_Help/Images/Autocomplete_arguments.png)

![](../../reuse/../TA4VS_Help/Images/aucomplete_arguments.png)
...
## Variable and function assistance { .section}
...
![](../../reuse/../TA_Help/Images/content_assist_variable_function.png)
...
-   As you enter an expression function, a screentip appears displaying the function's syntax.
    ...
    ![](../../reuse/../TA_Help/Images/content_assist_function_screentip.png)
...
## Applicable actions assistance {#section.applicable_actions .section}
