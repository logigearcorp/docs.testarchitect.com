...
---
# The test editor {#getting_started_the_test_editor .concept}
...
![](../Images/Test_Editor.png)

## Navigation {#section.intelligent_nav .section}
...
![](../../reuse/../TA_Help/Images/ug_thetesteditor1.png)
...
![](../../reuse/../TA_Help/Images/editor_line_continuation.png)

## Entering argument values { .section}
...
![](../../reuse/../TA_Help/Images/ug_thetesteditor2.png)
...
![](../../reuse/../TA_Help/Images/Test_Editor_comment_note.png)

Commenting is also used to temporarily *turn off* an action line:

![](../../reuse/../TA_Help/Images/Test_Editor_comment.png)
...
## Reformatting the test editor { .section}
...
## Automatic matching of paired actions { .section}
...
## Adjusting the row height or column width { .section}
