...
---
# Exporting a test case {#task_sdj_kgr_mn .task}
...
2.  In the Export Test Case dialog box, specify a location \(or click ![](../Images/btn.browse-ellipsis.01.png) to browse to a location\), specify a file name \(or accept the default\) to export to, then click **OK**.
...
**Previous topic:**[Exporting multiple test modules](../../TA_Help/Topics/Exporing_to_CSV_multiple_test_modules.html)
