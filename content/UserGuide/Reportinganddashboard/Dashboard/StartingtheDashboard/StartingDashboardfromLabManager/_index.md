...
---
# Starting Dashboard from Lab Manager {#Dashboard_starting_Lab_Manager .task}
...
3.  In the Lab Manager ribbon menu, click **Dashboard**.
    ...
    ![](../Images/Dashboard_from_Lab_Manager.png)
...
**Previous topic:**[Starting Dashboard from TestArchitect](../../TA_Help/Topics/Dashboard_starting_from_TA.html)

**Next topic:**[Starting Dashboard from a browser](../../TA_Help/Topics/Dashboard_starting_from_browser.html)
