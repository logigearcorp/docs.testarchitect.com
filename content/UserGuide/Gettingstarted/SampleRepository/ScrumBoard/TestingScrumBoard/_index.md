...
---
# Testing Scrum Board {#Enabling_TA_agent_IE_SB .task}
...
4.  Select the particular Scrum Board test \(for example, **Input Validation**\) you want to execute and click **Execute** ![](../Images/btn.TAC_toolbar.Execute.png) on the toolbar.
...
5.  In the Execute Test dialog box, click the **Select Version** button in the Variation Specification panel.
    ...
    ![](../Images/Scrumboard_Select_Version.png)
