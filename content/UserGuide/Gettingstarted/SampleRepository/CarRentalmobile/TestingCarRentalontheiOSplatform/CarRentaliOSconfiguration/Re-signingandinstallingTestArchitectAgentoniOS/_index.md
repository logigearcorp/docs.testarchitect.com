...
---
# Re-signing and installing TestArchitect Agent on iOS {#SR_Installing_TA_on_iOS .task}
...
7.  Connect the iOS device to the test machine using a USB cable, and install a re-signed TestArchitect Agent onto the device with iTunes.
    ...
    **Tip:** Step [7](../../iOS/Topics/iOS_installing_TA_target_device.md#step_tww_zzq_kn) may be performed on either an macOS or Windows machine.
