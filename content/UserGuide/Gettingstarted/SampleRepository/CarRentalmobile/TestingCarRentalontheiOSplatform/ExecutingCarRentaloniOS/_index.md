...
---
# Executing Car Rental on iOS {#Car_Rental_TA_Client .task}
...
-   In order to ensure that the [start program](../../TA_Automation/Topics/bia_start_program.html) built-in action can successfully launch Car Rental on iOS devices, refer to [Launching an AUT](../../iOS/Topics/iOS_launching_an_AUT.md#section_pdh_mzj_m4).
...
6.  Click **Execute** ![](../Images/btn.TAC_toolbar.Execute.png) on the toolbar.
