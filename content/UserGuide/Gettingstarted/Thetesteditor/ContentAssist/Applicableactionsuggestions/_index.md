...
---
# Applicable action suggestions for a window or control {#task_ux4_jbb_qp .task}
...
3.  Drag the selected item and drop it into an empty cell in column **A** in the test editor window.
    ...
    ![](../Images/applicable_BIA_column_A.png)
