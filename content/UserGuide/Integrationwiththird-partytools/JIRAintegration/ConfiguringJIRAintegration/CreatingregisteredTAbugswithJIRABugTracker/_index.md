...
---
# Creating registered TA bugs with JIRA Bug Tracker {#task_kgb_hyx_1m .task}
...
2.  In the New Bug dialog box, click the **Import** button.
    ...
    The Import Bug dialog box appears with the default user name and password configured in [Registering JIRA server](JIRA_registering.md#step_wxv_tc5_2m).
...
3.  In the **Bug ID** text box, specify the bug ID of a JIRA bug you would like to associate this TA bug with.
    ...
    ![](../Images/Import_bug_dialog_box.png)
...
4.  Click **OK**.
    ...
    ![](../Images/Associated_information.png)
...
![](../Images/Associated_bug_information_external_bug.png)
...
**Previous topic:**[Registering a JIRA server](../../TA_Help/Topics/JIRA_registering.html)
