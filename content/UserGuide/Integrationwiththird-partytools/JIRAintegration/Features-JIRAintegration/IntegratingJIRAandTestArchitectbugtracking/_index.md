...
---
# Integrating JIRA and TestArchitect bug tracking {#concept_b1k_dr2_bm .concept}
...
-   Based on TestArchitect's suggested change \(if any\) of bug status, you can decide whether or not the corresponding JIRA bug issue on the JIRA server should be closed, reopened, or resolved. \(Refer to [Suggested TA bug status](Bugs_working_known_bug_reviewing_test_results.md#section_m3b_t2l_wn) for details.\)
