--- 
title: "Uploading TestArchitect test results to Zephyr"
linktitle: "Uploading TestArchitect test results to Zephyr"
weight: 5
aliases: 
    - /TA_Help/Topics/ug_Zephyr_uploading_results.html
---
# Uploading TestArchitect test results to Zephyr {#concept_mbq_qr4_jp .concept}
...
**Previous topic:**[Mapping TestArchitect test modules to Zephyr test cases](../../TA_Help/Topics/Zephyr_mapping_TM.html)

**Next topic:**[Executing tests from Zephyr](../../TA_Help/Topics/ug_Zephyr_executing_tests.html)
