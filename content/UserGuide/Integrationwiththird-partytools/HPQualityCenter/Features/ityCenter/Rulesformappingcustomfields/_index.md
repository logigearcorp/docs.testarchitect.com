...
---
# Rules for mapping custom fields between TestArchitect and Quality Center {#QC_creating_custom_field_rules .concept}
...
-   In TestArchitect, the data type is set in the TestArchitect **Value Type** field in the [New Field](../../TA_Administration/Topics/User_defined_fields_create.md#stepresult_q44_hls_mq) dialog box.
...
In addition to choosing the correct data type for each user-defined field, you also must match the TestArchitect **Apply To** entity in the [New Field](../../TA_Administration/Topics/User_defined_fields_create.md#stepresult_q44_hls_mq) dialog box with the project entity in Quality Center. The following table displays the mapping relationships between TestArchitect **Apply To** entities and Quality Center Project entities.
