...
---
# Adding Team Foundation Server - support fields to TestArchitect {#Bugs_defined_field_TFS .task}
...
2.  Create a [registered bug](ug_TFS_BugTracker_creatingTAbugs.md#). Note that the new field appears in it.


The TestArchitect user-defined field loads additional value from TFS field, as depicted below:

![](../Images/Bug_user_define_fields_TFS.png)
