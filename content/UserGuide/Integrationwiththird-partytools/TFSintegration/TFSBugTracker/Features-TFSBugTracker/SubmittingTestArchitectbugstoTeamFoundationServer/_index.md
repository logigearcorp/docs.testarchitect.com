...
---
# Submitting TestArchitect bugs to Team Foundation Server {#TFS_submitting_bug .task}

Submitting a bug from TestArchitect directly to a TFS server creates a new TFS bug on the server.

Ensure that the following requirements are met:

-   Your TestArchitect test machine has [registered the TFS server](Integration_MTM_connecting_TFS.md#).
-   Your TestArchitect test machine has [actived the TFS bug tracker](ug_TFS_BugTracker_Registering_bugtracker.md#).
...
2.  On the main panel's toolbar, click the **Submit Bug to Bug Tracking System** ![](../Images/Submit_bug_to_JIRA_icon.png) icon.
...
7.  In the notification message
    ...
    ![](../Images/Submit_bug_to_JIRA_confirmation.png)
