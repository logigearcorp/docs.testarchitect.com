...
---
# Configuring run settings {#task_rcv_zhg_sq .task}
...
3.  In the **Test environment** list of the **Automated runs** group of the plan properties, select a [lab environment](ug_MTM_create_lab_environment.html) in which you want to run your tests.
    ...
    ![](../Images/MTM_select_environment.png)
...
4.  Associate a build containing your tests with the test plan:
    ...
    ![](../Images/MTM_assign_build_definition.png)

5.  Click the **Save** ![](../Images/mtm_save_btn.png) button to save the changes made to your test plan and close the Test Plan Properties page.
