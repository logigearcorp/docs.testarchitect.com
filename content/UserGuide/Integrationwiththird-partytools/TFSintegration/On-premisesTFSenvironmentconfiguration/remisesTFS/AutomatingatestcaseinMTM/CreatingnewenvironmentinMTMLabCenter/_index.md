...
---
# Creating a new environment in the Microsoft Test Manager Lab Center {#task_tfp_wfg_sq .task}
...
3.  Keep in mind the following specific settings:
    ...
    -   In the **Type and name** step, select the **Standard environment** option.
        ...
        ![](../Images/ug_MTM_new_environment.png)
    ...
    -   Select **Desktop client** for machine role.
        ...
        **Note:**
        ...
        ![](../Images/ug_MTM_add_machine_2.png)
...
![](../Images/MTM_new_created_environment.png)
