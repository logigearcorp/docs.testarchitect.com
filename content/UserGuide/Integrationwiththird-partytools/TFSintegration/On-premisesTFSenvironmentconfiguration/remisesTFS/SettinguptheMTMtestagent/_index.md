...
---
# Configuring and registering an MTM test agent {#task_pwj_glh_sq .task}
...
2.  Keep in mind the following specific settings:
    ...
    -   When presented with the Configure Test Agent dialog box in Visual Studio, choose to run the test agent as an Interactive process.
        ...
        ![](../Images/MTM_TA_interactive_process.png)
    ...
    ![](../Images/config_summary_dlg_test_agent.png)

3.  Click **Close** to close the dialog box.


With a test agent installed, an icon ![](../Images/MTM_agent_icon.png) appears in the Windows notification area. Open it to display the status of the test agent.

![](../Images/agent_systray.png)
