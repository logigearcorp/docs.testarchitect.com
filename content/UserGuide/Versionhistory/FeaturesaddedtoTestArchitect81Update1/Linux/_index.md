...
---
# What's new in TestArchitect for Linux {#concept_what_new_8.1_U1_Linux .concept}
...
-   **Support for Chrome Android testing**: You can now use TestArchitect to create automated GUI and functional tests in the [Google Chrome](../../TA_Automation/Topics/aut_app_testing_mobile_web_Android.html) mobile web browser on Android devices.
    -   Special handling of [Javascript popups on Chrome](../../TA_Automation/Topics/aut_app_testing_Android_apps_popups.html): Due to the manner in which the web browser engine processes JavaScript code, modal popup windows produced in a web application with JavaScript cannot be tested in a conventional manner. To address this issue, TestArchitect offers a special set of actions for interfacing with Javascript popups, including alerts, prompts and confirmation dialogs.
