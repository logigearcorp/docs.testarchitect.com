...
---
# What's new in TestArchitect for Windows {#concept_what_new_8.1_U1_Wins .concept}
...
-   **Integration with Microsoft Test Manager**: Additional options when executing test cases in Microsoft Test Manager:
    -   [**Screenshot recording**](../../TA_Help/Topics/ug_TestArchitect_execution_dialog.md#li_Screenshot.recording): Configure the capturing of [screenshots of UI-Interacting actions](../../TA_Help/Topics/ug_Screenshot_recording.md#li.screenshot.exec_test_dlg.settings).
    -   [**Include screenshots**](../../TA_Help/Topics/ug_TestArchitect_execution_dialog.md#li_Include.scrn): Retain all captured screenshots in the exported HTML test result.
...
**Parent topic:**[Features added to TestArchitect 8.1 Update 1](../../TA_ReleaseNotes/DITA_source/Whats_New_8.1_update_1.html)
