...
---
# Features added to TestArchitect 8 {#concept_what_new_8 .concept}
...
-   **Option to open the parent results folder** upon export of test results. \(Refer to [Exporting test results to a ZIP file](../../TA_Help/Topics/Test_result_export_ZIP.html) and [Exporting test results to an HTML file](../../TA_Help/Topics/Test_result_export_HTML.html) for details.\)
...
**Previous topic:**[Features added to TestArchitect 8 Update 1](../../TA_ReleaseNotes/DITA_source/Whats_New_8_update_1.html)

**Next topic:**[Features added to TestArchitect 8 beta 2](../../TA_ReleaseNotes/DITA_source/Whats_New_8.0_beta_2.html)
