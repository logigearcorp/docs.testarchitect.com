...
---
# What's new in TestArchitect for Windows {#concept_what_new_8.1_U3_Wins .concept}
...
-   **Web automation on Google Chrome** now utilizes Google's **[Remote Debugging](../../TA_Help/Topics/Test_exec_extension.md#li_d2m_vks_tr) technical approach**. Google is phasing out support for NPAPI , the technology previously employed by TestArchitect to automate web applications on Chrome.
