...
---
# What's new in TestArchitect for Windows {#concept_what_new_8.3_Windows_update_1 .concept}
...
-   Test results improvements:
    ...
    -   **Overview of the number of automation failures, errors, and warnings** of user-defined actions are [summarized](../../TA_Help/Topics/Test_result_details.md#li.Error_warning_failures_summary) at the top level of the actions.
    -   [**Failure Summary**](../../TA_Help/Topics/Test_result_details.md#li.Error_warning_failures_summary) table residing in the **Results Details** tab, and the [**Screenshot**](../../TA_Help/Topics/ug_results_failure_error_summary.html) column residing in the **Failure/Error Summary** tab are supplemented for quick references.
    -   [**Step Summary** table residing in the **Summary** tab](../../TA_Help/Topics/Test_result_summaries.md#sectiondiv.step_summary_table): With the support of this table, you might take a quick glance at which test steps have automation problems. Also you might grab the test flow thoroughly when you can identify the exact test steps in which the failures, errors, or warnings occur.
    ...
    -   [**Video snapshot directory**](../../TA_Help/Topics/ug_Screenshot_recording.md#section.Video_playback) field: The location at which [screen-recording videos](../../TA_Help/Topics/ug_Screenshot_recording.md#section.Video_playback) \(taken during the automated test runs\) are stored.
...
-   **Web automation on Mozilla Firefox** now utilizes the [GeckoDriver](../../TA_Help/Topics/Test_exec_extension.md#li.FF) technical approach, since Mozilla intends to remove the support for most NPAPI plugins in Firefox, the technology previously employed by TestArchitect to automate web applications on Firefox.
...
## Deprecation {#section_qls_4jc_xz .section}
...
## New Privacy Policy {#section.TA_policy .section}

-   About [TestArchitect’s policy](http://go.testarchitect.com/fwlink/?linkid=90002)

**Parent topic:**[Features added to TestArchitect 8.3 Update 1](../../TA_ReleaseNotes/DITA_source/Whats_New_8.3_update_1.html)
