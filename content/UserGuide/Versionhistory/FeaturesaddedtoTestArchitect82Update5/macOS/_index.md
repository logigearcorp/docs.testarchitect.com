...
-   **Support for automation on macOS 10.11**: You can now perform the following types of testing with a test controller running under macOS 10.11:
    -   **Automate web applications on [Safari](../../TA_Automation/Topics/Web_automation.md#li_pbz_fkq_js) in physical iOS devices.**
    -   **Automated [native applications](../../iOS/Topics/iOS_automation_def.md#row.Mac_version) on iOS devices.**
