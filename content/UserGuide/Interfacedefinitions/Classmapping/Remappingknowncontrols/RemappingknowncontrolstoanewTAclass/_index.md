...
---
# Remapping known controls to a new TA class {#Remapping_unknown_controls_new_class .task}
...
3.  In the UI explorer tree panel, navigate to your choice of a known class \(as indicated by a gear ![](../Images/ug_interface_definition46.png) icon\), right-click a control node under it, and then click **Map to New Class**.
