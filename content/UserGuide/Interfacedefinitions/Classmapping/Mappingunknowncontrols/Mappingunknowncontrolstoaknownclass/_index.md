...
---
# Mapping unknown controls to a known class {#Mapping_unknown_controls_known_class .task}
...
3.  In the UI explorer tree panel, navigate to your choice of an unknown class \(as indicated by a ![](../Images/ug_interface_definition41.png) icon\), right-click a control node under it, and then click **Map to Known Class**.

    The Map to Known Class dialog box is displayed.

    ![](../Images/Map_to_known_class_dialog.png)
