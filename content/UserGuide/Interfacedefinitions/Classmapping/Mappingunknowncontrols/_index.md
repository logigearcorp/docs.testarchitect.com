...
If you attempt to capture a control whose class is unknown \(![](../Images/ug_interface_definition41.png)\), TestArchitect displays an alert requiring that you map that control's class to either

1.  a known class \(an existing built-in or user-defined TA class\) or
2.  a *new* user-defined TA class.

![](../Images/Interface_viewer_capturing_unknown_control.png)
