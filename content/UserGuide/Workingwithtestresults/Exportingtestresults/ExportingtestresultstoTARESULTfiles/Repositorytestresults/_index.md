...
---
# Exporting repository test results to .TARESULT files {#ug_test_results_export_repo_results_TARESULT .task}
...
2.  Invoke the Export Result\(s\) To File dialog box by doing one of the following:
    ...
    -   Double-click the selection, and then click the **Export test result** ![](../Images/Save_to_file_HTML_icon.png) icon on the main panel's icon bar.
    The Export Result\(s\) To File appears.

    ![](../Images/Export_Results_To_File_taresult.dlg.png)
