...
---
# Viewing bugs related to a test module or test case {#task_o1p_rzq_fm .task}
...
2.  On the main panel, select the **Related bugs** tab.
    ...
    -   If you selected a test module, the **Related bugs** tab appears with a list view of related bugs:
        ...
        |**Status**|The current life cycle stage of this TA bug. \(See [Workflow](Bugs.md#ksec_tabugs_workflow).\)|
