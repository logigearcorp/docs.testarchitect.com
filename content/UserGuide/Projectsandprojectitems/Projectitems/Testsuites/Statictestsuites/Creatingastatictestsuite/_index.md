...
---
# Creating a static test suite {#test_suite_static_creation .task}
...
-   **Option \#1**:
    ...
    1.  Select the **Test Suites** node ![](../Images/test_suite_item_add_icon.png) in the TestArchitect explorer tree.
    ...
    3.  In the New Test Suite dialog box, specify the details of the test suite:
        ...
        ![](../Images/create_static_test_suite.png)

    4.  Click **Create**.

-   **Option \#2:**

    1.  In the TestArchitect explorer tree, right-click the **Test Suites** node ![](../Images/test_suite_item_add_icon.png) , then click **New Test Suite**.
...
-   **Option \#3**:
    ...
    4.  In the New Test Suite dialog box, specify the details of the static test suite:
        ...
        ![](../Images/create_static_test_suite_from_Execute_Test_dlg.png)
...
![](../Images/create_test_suite_node.png)
