...
---
# Picture check list view {#picture_check_list_view .concept}
...
On the TestArchitect explorer tree, when you double-click the **Picture Checks** node, and then select the **Pictures** tab. TestArchitect displays in the main panel a list view of the picture checks for the project. \([Learn more](Projects_and_tests_picture_check.html).\)

**Note:** Picture check list views are also available for subfolders of the **Picture Checks** node.

![](../Images/Listview_picture_check.png)

Following operations can be performed on the picture check list view:

## Common operations { .section}

You can find various common operations that can be performed on the contents of picture check list views at [Common operations](Listview_common_operations.html).

## Opening multiple picture checks { .section}
...
## Adding new baseline { .section}

You can save a captured screen image as a new baseline for an existing image. \(For details, see [Saving new baseline image](Additional_features_image_capturing_add_new_baseline.html) and [Baseline Picture](Projects_and_tests_picture_check.md#section_mwp_1d1_1l).\)
...
**Previous topic:**[Test suite list view](../../TA_Help/Topics/Listview_test_suite.html)

**Next topic:**[Result list view](../../TA_Help/Topics/Listview_results.html)
