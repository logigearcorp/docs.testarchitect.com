...
---
# Test suite list view {#test_suite_list_view .concept}
...
![](../Images/Listview_test_suite.png)
...
## Generating a batch file { .section}
...
## Rearranging test modules in a static test suite { .section}
