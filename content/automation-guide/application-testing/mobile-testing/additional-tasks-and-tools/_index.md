...
1.  [Device Live Screen](/automation-guide/application-testing/mobile-testing/additional-tasks-and-tools/device-live-screen/)  
...
2.  [Capturing screenshots of a mobile device](/automation-guide/application-testing/mobile-testing/additional-tasks-and-tools/capturing-screenshots-of-a-mobile-device)  
...
3.  [Running automated tests on multiple mobile devices](/automation-guide/application-testing/mobile-testing/additional-tasks-and-tools/running-automated-tests-on-multiple-mobile-devices)  
...
4.  [Executing cross-platform mobile automated tests](/automation-guide/application-testing/mobile-testing/additional-tasks-and-tools/executing-cross-platform-mobile-automated-tests/)  

5.  [Constructing a video link to record all screenshots during automation on cloud services](/automation-guide/application-testing/mobile-testing/additional-tasks-and-tools/constructing-a-video-link-to-record-all-screenshots-during-automation-on-cloud-services/)  
