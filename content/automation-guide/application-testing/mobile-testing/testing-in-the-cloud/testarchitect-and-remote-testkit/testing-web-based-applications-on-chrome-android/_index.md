--- 
title: "Testing web based-applications on Chrome Android"
linktitle: "Testing web based-applications on Chrome Android"
description: "Using TestArchitect, you can create and run automated tests for mobile web applications (Google Chrome) on Android cloud devices rented in the Remote TestKit service."
weight: 2
aliases: 
    - /TA_Automation/Topics/aut_app_cloud_testing_RTK_Chrome.html
keywords: 
---
...
1.  [Prerequisites](/automation-guide/application-testing/mobile-testing/testing-in-the-cloud/testarchitect-and-remote-testkit/testing-web-based-applications-on-chrome-android/prerequisites/)  
Describes prerequisites for automating Chrome on Android cloud mobile devices.
2.  [Creating mobile web application test](/automation-guide/application-testing/mobile-testing/testing-in-the-cloud/testarchitect-and-remote-testkit/testing-web-based-applications-on-chrome-android/creating-a-test/)  
