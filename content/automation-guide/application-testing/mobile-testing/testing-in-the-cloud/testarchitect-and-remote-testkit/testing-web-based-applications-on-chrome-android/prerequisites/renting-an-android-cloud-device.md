...
2.  In the Device list - Remote TestKit dialog box, rent and launch a device.
    ...
    {{<remember>}} Note down the Android version of the rented device. This information is necessary while [configuring](/automation-guide/application-testing/mobile-testing/testing-in-the-cloud/testarchitect-and-remote-testkit/testing-web-based-applications-on-chrome-android/prerequisites/configuring-appium-server-locally) Appium in your local host.
...
5.  If your Google Chrome's version on the rented Android cloud device is 53 or later, [update](/automation-guide/application-testing/mobile-testing/testing-in-the-cloud/testarchitect-and-remote-testkit/testing-web-based-applications-on-chrome-android/prerequisites/updating-chromedriver) the version of ChromeDriver. Otherwise, skip this step.
