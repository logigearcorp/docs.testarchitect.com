...
In TestArchitect, desired capabilities are defined through the [assign cloud device](assign_cloud_device.html) built-in action \([learn more](aut_app_cloud_testing_RTK_Android_Chrome_automation.html)\), or in a JSON file \([learn more](aut_app_cloud_testing_Appium_RTK_multiple_Android_cloud_devices.html)\).
