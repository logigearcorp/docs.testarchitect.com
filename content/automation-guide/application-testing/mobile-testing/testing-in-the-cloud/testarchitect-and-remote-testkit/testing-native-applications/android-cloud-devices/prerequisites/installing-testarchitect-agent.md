...
1.  Activate a device from the Remote TestKit Client application. \([Learn more](/automation-guide/application-testing/mobile-testing/testing-in-the-cloud/testarchitect-and-remote-testkit/testing-native-applications/android-cloud-devices/prerequisites/enabling-the-android-adb-command).\)
