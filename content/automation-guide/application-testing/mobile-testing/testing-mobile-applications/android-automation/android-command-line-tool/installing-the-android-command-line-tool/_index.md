...
description: "The Install command is used to re-sign an Android application, and then to install it."
weight: 1
aliases: 
    - /Android/Topics/Android_command_line_tool_install.html
keywords: "Android, command line tool, installing app, command line tool, Android, installation, Android command line tool, installing"
---
