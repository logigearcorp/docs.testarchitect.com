...
description: "The Start command is used to launch an Android application from an Android device."
weight: 2
aliases: 
    - /Android/Topics/Android_command_line_tool_start.html
keywords: "Android, command line tool, launching app, command line tool, Android, launching, Android command line tool, starting"
---
