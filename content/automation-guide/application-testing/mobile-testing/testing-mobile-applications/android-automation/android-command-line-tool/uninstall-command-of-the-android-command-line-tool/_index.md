...
description: "The Uninstall command is used to uninstall an application from an Android device."
weight: 3
aliases: 
    - /Android/Topics/Android_command_line_tool_uninstall.html
keywords: "Android, command line tool, uninstalling app, command line tool, Android, uninstalling, Android command line tool"
---
...
-   **[Uninstalling an Android application from the command line tool](/automation-guide/application-testing/mobile-testing/testing-mobile-applications/android-automation/android-command-line-tool/uninstall-command-of-the-android-command-line-tool/uninstalling-an-android-application-from-the-command-line-tool)**  
