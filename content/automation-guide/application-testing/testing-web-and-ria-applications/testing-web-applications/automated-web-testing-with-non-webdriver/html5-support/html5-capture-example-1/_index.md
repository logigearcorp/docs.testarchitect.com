...
![](/images//Images/html5_capture_polygon.png)
...
3.  Click the **Identify** button ![](/images//Images/identify_btn.png) on the toolbar.
...
4.  Navigate to the polygon on the AUT. As you pass your cursor over the polygon, an orange, rectangular frame appears around the polygon, along with a screentip indicating the TA class of the text box, TAClass: SVG.
    ...
    ![](/images//Images/html5_identify_tooltip.png)
...
5.  Click into the polygon on the AUT.
    ...
    ![](/images//Images/html5_element_definition.png)
...
**Previous topic:**[HTML5 enhancements](/TA_Automation/Topics/HTML5_automation_enhancements.html)

**Next topic:**[HTML5 Capture - Example \# 2](/TA_Automation/Topics/HTML5_automation_example_2.html)
