...
1.  Start Mozilla Firefox, then access the **Add-ons Manager**:
    ...
    -   If using Firefox version 29 or later, click the Menu ![](/images//Images/btn.Firefox_Australis.menu.png) button, then select **Add-ons**.
...
3.  Look for the add-on named TestArchitect Automation Agent and check that its status is not Disabled. If the status is Disabled, click the **Enable** button to enable the add-on.
    ...
    ![](/images//Images/ug_taextension_firefox.png)
...
**Next topic:**[Enabling the TAWebPlugin plug-in](/TA_Automation/Topics/aut_enabling_TAWebPlugin_FF.html)
