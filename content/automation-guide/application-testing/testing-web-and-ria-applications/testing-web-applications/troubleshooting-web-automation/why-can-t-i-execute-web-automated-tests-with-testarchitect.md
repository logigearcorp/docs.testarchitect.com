...
-   **Case 1**: If you installed your browser prior to installing TestArchitect, the TestArchitect Automation Agent was automatically installed in your browser. However, you still need to configure settings to enable the TestArchitect Automation Agent.
    ...
    2.  For Internet Explorer \(see [TestArchitect Automation Agent in Internet Explorer](/automation-guide/application-testing/testing-web-and-ria-applications/testing-web-applications/automated-web-testing-with-non-webdriver/preparing-web-browsers/preparing-internet-explorer-for-web-testing/)\).
