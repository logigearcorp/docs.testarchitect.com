...
1.  [setting](setting.html) \[[webdriver mode](webdriver_mode.html)\] \[on\]: to activate the WebDriver mode.
2.  [navigate](navigate.html): to go to the test web page.
...
You can set up an environment using the [configure webdriver](configure_webdriver.html) built-in action.
