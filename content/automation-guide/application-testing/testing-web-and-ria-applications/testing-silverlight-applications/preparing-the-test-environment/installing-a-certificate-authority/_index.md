...
3.  In the Certificate dialog box, click **Install Certificate**.
    ...
    ![](/images//Images/install_CA.png)

4.  In the Certificate Import Wizard dialog box, click **Next**.

    ![](/images//Images/CA_Import_Wizard_dlg.png)

5.  Choose the **Place all certificates in the following store** option and click **Browse**.

    ![](/images//Images/CA_Import_Wizard_dlg_1.png)

6.  Select **Trusted Root Certification Authorities** and click **OK**.

    ![](/images//Images/Select_certificate_store_dlg.png)

7.  Click **Next**.

    ![](/images//Images/CA_Import_Wizard_dlg_3.png)

8.  Click **Finish**.

    ![](/images//Images/CA_Import_Wizard_dlg_4.png)
...
9.  Click **Yes** in response to the security warning to install the certificate.
    ...
    ![](/images//Images/install_CA_confirmation.png)
