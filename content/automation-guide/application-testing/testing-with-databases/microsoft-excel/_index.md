...
Use the action [create connection string](create_connection_string.html) to establish an ODBC connection to the Excel file. Note that the action's driver argument should have one of the following values:
