...
Ensure that you installed and configured Oracle Database. \([Learn more](/automation-guide/application-testing/testing-with-databases/oracle/windows-machines/oracle-database-enterprise-edition/installing-and-configuring-oracle-database-enterprise).\)
