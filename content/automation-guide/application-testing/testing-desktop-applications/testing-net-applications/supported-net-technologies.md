...
-   Standard .NET controls. \(See [Support for .NET Applications' Controls](/automation-guide/application-testing/testing-desktop-applications/testing-net-applications/list-of-supported-net-controls/).\)
-   ASP.NET web applications. \(See [Testing web applications](/automation-guide/application-testing/testing-web-and-ria-applications/testing-web-applications/#section_ipl_bzc_m4) for details regarding how to test ASP.NET web applications with TestArchitect.
