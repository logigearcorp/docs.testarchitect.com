...
Note that this generation of a text-based mappings file has no effect on your existing project. To incorporate the updated mappings into your project, your next step is to copy the file's contents into the $Class Maps interface entity. \([Learn more.](/user-guide/interface-definitions/class-mapping/support-for-winforms-class-mapping)\)
