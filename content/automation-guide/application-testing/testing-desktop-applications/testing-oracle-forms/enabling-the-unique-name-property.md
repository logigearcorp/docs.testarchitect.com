...
-   Now you can use the TestArchitect's [Interface Viewer](/user-guide/interface-definitions/the-interface-viewer/) to capture Oracle Forms controls which have the unique name property \(see the image below\).
