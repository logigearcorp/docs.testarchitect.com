...
description: ".NET Framework versions and WPF controls supported by TestArchitect."
weight: 2
aliases: 
    - /TA_Automation/Topics/aut_app_testing_WPF_apps_supported_technology.html
keywords: "WPF testing, supported WPF technologies"
---
...
-   Standard WPF controls. \(See [Support for WPF Applications' Controls](/automation-guide/application-testing/testing-desktop-applications/testing-wpf-applications/list-of-supported-wpf-controls).\)
