...
**Note:** See [the table](timing_summary.html#imgtbl_summary_actions_timesettings_results) in [the summary](timing_summary.html) for a more detailed look at the relationships between action types, timing settings, preconditions, conditions, and results.
