...
-   min edge length can also be set through the dedicated [set ocr setting](set_ocr_setting.html) action, as well as through the [setting](setting.html) action.
