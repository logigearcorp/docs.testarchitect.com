...
-   Examples of get/check value actions are as follows: [check](check.html), [check control property](check_control_property.html), [check control tooltip](check_control_tooltip.html), [get](get.html), [get column number](get_column_number.html), etc.
