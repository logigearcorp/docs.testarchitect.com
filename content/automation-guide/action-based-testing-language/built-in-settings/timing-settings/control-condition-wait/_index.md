...
This built-in setting only takes effect when it is used in combination with the [control condition](/TA_Automation/Topics/bis_control_condition.html) built-in setting.
