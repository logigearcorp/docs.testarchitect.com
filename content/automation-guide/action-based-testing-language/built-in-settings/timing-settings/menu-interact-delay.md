...
description: "Description Specifies the delay before clicking the next menu items. Value Units milliseconds Default Value 100 Applicable Systems/Platforms This built-in setting is supported on the following ..."
weight: 7
aliases: 
