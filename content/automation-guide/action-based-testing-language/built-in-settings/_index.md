...
TestArchitect has a number of built-in settings that control various runtime behaviors of TestArchitect.All built-in settings are assigned non-empty default values by TestArchitect prior to the start of each test run. These defaults can be overridden, however, during either [run setup time](/user-guide/support/glossary-of-terms/run-setup-time) \([learn more](/user-guide/test-execution/startup-settings/creating-a-startup-setting-for-a-built-in-setting)\), or during [run time](/user-guide/support/glossary-of-terms/run-time) by means of the built-in [setting](/automation-guide/action-based-testing-language/built-in-actions/test-support-actions/value-handling/setting) action.

1.  [Date, time settings](/automation-guide/action-based-testing-language/built-in-settings/date-time-settings/)  
...
2.  [Timing settings](/automation-guide/action-based-testing-language/built-in-settings/timing-settings/)  
...
3.  [Value settings](/automation-guide/action-based-testing-language/built-in-settings/value-settings/)  
...
4.  [Other settings](/automation-guide/action-based-testing-language/built-in-settings/other-settings/)  
...
5.  [Playback settings](/automation-guide/action-based-testing-language/built-in-settings/playback-settings/)  
Settings that operate on CodedUI’s value are classified as playback settings.
6.  [Deprecated](/automation-guide/action-based-testing-language/built-in-settings/deprecated/)  
