...
---
keyword: [check if string matches pattern, check whether string matches pattern, check if text follows pattern, verify if string matches pattern, verify whether text follows pattern]
---
