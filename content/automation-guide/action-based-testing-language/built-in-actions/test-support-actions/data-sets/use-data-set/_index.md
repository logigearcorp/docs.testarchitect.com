...
-   **filter**
    ...
    Filter criteria, or a named filter \(see [filter](filter.html) built-in action\).
...
-   This action establishes a loop which is terminated by a matching [repeat for data set](repeat_for_data_set.html) action.
