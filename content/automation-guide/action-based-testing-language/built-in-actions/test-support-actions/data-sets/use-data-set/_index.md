...
-   **filter**
    ...
    Filter criteria, or a named filter \(see [filter](/TA_Automation/Topics/bia_filter.html) built-in action\).
...
-   This action establishes a loop which is terminated by a matching [repeat for data set](/TA_Automation/Topics/bia_repeat_for_data_set.html) action.
