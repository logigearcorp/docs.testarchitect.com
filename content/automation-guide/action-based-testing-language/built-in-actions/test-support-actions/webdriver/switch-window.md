...
## {{< expand >}} Description {{< permerlink >}} {#bia_switch_window__section_b1x_zh3_wfb} 

Switch to another window instance.

{{<important>}} This action is dedicated to Generic WebDriver.

## {{< expand >}} Arguments {{< permerlink >}} {#bia_switch_window__section_qk2_f33_wfb} 
...
## {{< expand >}} Note {{< permerlink >}} {#bia_switch_window__section_amm_1rj_wfb} 
...
## {{< expand >}} Example {{< permerlink >}} {#bia_switch_window__section_uxg_4zj_wfb} 
...
## {{< expand >}} Action lines {{< permerlink >}} {#bia_switch_window__section_ryc_tzj_wfb} 
