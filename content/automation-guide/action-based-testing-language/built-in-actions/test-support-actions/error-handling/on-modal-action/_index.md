...
description: "Description Specify the action to be invoked in the event of the appearance of a modal dialog box which would otherwise disrupt the intended flow of test automation. Arguments action (Optional) Name ..."
weight: 4
aliases: 
