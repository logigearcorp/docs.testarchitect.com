...
-   If the given window does not close before the specified timeout, a warning is generated. By default \(that is, unless the [notice level](notice_level.html) setting has been modified in your test\) you are presented with a modal dialog box asking whether to continue the test.
