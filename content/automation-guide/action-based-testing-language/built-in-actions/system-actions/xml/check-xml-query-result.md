...
description: "Description Check an XPath query result against an expected string. Result is Passed if the strings match ; otherwise Failed . Arguments xml XML target string that the query runs against. Tip: To ..."
weight: 1
aliases: 
