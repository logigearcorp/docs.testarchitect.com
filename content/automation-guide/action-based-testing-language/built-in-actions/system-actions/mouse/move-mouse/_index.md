...
description: "Description Move the mouse pointer to a specified location within a control. Arguments window (Optional) TA name of the window. control (Optional) TA name of the control. x (Optional) Horizontal ..."
weight: 6
aliases: 
    - /TA_Automation/Topics/bia_move_mouse.html
keywords: "built-in actions, move mouse, move mouse (action), move mouse, move mouse to position, move mouse to position within control"
---
...
![](/images/TA_Automation/Images/bia_move_mouse_aut.png)

## Action Lines

![](/images/TA_Automation/Images/bia_move_mouse_pgm.png)

## Result

![](/images/TA_Automation/Images/bia_move_mouse_res.png)
