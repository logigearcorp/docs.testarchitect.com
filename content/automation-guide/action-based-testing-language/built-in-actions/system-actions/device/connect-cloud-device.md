...
## {{< expand >}} Description {{< permerlink >}} {#bia_connect_cloud_device__section_nkt_zth_gy} 

Logically connect to a cloud-based device and make that device the target for the automation.

## {{< expand >}} Arguments {{< permerlink >}} {#bia_connect_cloud_device__section_okt_zth_gy} 
...
## {{< expand >}} Notes {{< permerlink >}} {#bia_connect_cloud_device__section_qkt_zth_gy} 
...
## {{< expand >}} Example {{< permerlink >}} {#bia_connect_cloud_device__section_wkt_zth_gy} 
