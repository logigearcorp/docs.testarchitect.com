...
## {{< expand >}} Description {{< permerlink >}} {#bia_use_cloud_device__section_nkt_zth_gy} 

Use a cloud device, as specified by its session ID, to run automated tests.

## {{< expand >}} Arguments {{< permerlink >}} {#bia_use_cloud_device__section_okt_zth_gy} 
...
## {{< expand >}} Notes {{< permerlink >}} {#bia_use_cloud_device__section_qkt_zth_gy} 
...
## {{< expand >}} Example {{< permerlink >}} {#bia_use_cloud_device__section_wkt_zth_gy} 
