...
## {{< expand >}} Description {{< permerlink >}} {#bia_assign_cloud_device__section_nkt_zth_gy} 
...
## {{< expand >}} Arguments {{< permerlink >}} {#bia_assign_cloud_device__section_okt_zth_gy} 
...
## {{< expand >}} Valid contexts {{< permerlink >}} {#bia_assign_cloud_device__section_pkt_zth_gy} 

This action may be used within the following project items:test modules and user-defined actions.

## {{< expand >}} Notes {{< permerlink >}} {#bia_assign_cloud_device__section_qkt_zth_gy} 
...
## {{< expand >}} Example {{< permerlink >}} {#bia_assign_cloud_device__section_wkt_zth_gy} 
