...
description: "Description Check a JSON query result against an expected string. The result is Passed if the strings match; otherwise it is Failed . Arguments json JSON target document that the query runs against. ..."
weight: 1
aliases: 
    - /TA_Automation/Topics/bia_check_json_query_result.html
keywords: "built-in actions, check json query result, check json query result (action), check json query, json query check"
---

## {{< expand >}} Description {{< permerlink >}} {#bia_check_json_query_result__section_iyg_dsd_1y} 

Check a JSON query result against an expected string. The result is Passed if the strings match; otherwise it is Failed.

## {{< expand >}} Arguments {{< permerlink >}} {#bia_check_json_query_result__section_jyg_dsd_1y} 
...
## {{< expand >}} Valid contexts {{< permerlink >}} {#bia_check_json_query_result__section_kyg_dsd_1y} 

This action may be used within the following project items:test modules and user-defined actions.

## {{< expand >}} Notes {{< permerlink >}} {#bia_check_json_query_result__section_lyg_dsd_1y} 
...
## {{< expand >}} Example {{< permerlink >}} {#bia_check_json_query_result__section_pyg_dsd_1y} 
...
![](/images/TA_Automation/Images/bia_check_json_query_result_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_check_json_query_result_res.png)
