...
keywords: "check value of table view cell, check value of specific table view cell against expected value, check if value of specified table view cell matches expected value, check whether value specified of table cell matches expected value, verify if value of specific table cell matches expected value"
---
