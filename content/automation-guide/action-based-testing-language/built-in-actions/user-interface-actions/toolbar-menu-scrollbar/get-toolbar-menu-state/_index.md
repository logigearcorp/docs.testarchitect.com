...
keywords: "get toolbar menu state, get state of specified item on drop-down menu on toolbar button, retrieve state of given item on drop-down menu on toolbar button"
---
