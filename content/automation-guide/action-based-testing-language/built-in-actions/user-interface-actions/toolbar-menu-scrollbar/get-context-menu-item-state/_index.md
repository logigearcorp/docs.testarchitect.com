...
keywords: "get context menu item state, get state of specific context menu item, retrieve state of specified item on context menu, retrieve current state of given item on context menu"
---
...
![](/images//Images/bia_get_context_menu_item_state_aut.png)

**Action Lines**

![](/images//Images/bia_get_context_menu_item_state_pgm.png)

**Result**

![](/images//Images/bia_get_context_menu_item_state_res.png)

## Example - Case 2: Use numerical index value

![](/images//Images/bia_get_context_menu_item_state_index_aut.png)

**Action Lines**

![](/images//Images/bia_get_context_menu_item_state_index_pgm.png)

**Result**

![](/images//Images/bia_get_context_menu_item_state_index_res.png)
