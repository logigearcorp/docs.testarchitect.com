...
description: "Description Select an item on a specified context menu. Arguments window TA name of the window. control (Optional) TA name of the control holding the context menu. item Menu item or menu item path ..."
weight: 29
aliases: 
    - /TA_Automation/Topics/bia_select_context_menu_item.html
keywords: "built-in actions, select context menu item, select context menu item (action), iOS (action), select context menu item, Android (action), select specific item on context menu"
---
