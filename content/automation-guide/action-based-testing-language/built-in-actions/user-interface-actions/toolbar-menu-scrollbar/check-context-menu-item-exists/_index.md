...
keywords: "check context menu item exists, check for existence of specified item on context menu, check whether specified item on context menu, check if specified item is found on text menu, verify existence of specified item on context menu"
---
