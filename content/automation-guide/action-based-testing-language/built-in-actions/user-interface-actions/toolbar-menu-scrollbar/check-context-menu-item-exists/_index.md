...
---
keyword: [check context menu item exists, check for existence of specified item on context menu, check whether specified item on context menu, check if specified item is found on text menu, verify existence of specified item on context menu]
---

# check context menu item exists
...
![](/images//Images/bia_check_context_menu_item_exists_index_aut.png)

**Action Lines**

![](/images//Images/bia_check_context_menu_item_exists_index_pgm.png)

**Result**

![](/images//Images/bia_check_context_menu_item_exists_index_res.png)
...
![](/images//Images/bia_check_context_menu_item_exists_ta4vs_pgm.png)

**Result**

![](/images//Images/bia_check_context_menu_item_exists_ta4vs_res.png)
