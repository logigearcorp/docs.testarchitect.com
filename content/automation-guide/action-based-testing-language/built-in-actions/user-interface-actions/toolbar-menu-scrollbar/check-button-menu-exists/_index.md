...
keywords: "check for existence of specified menu item in drop-down button, check if specific menu item in drop-down button exists, check whether given specific menu item in drop-down button exists, verify if specific menu item in drop-down button exists, verify existence of specific menu item in drop-down button"
---
