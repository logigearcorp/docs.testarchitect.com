...
---
keyword: [check context menu item not exists, check if specified item on context menu does not exist, check for nonexistence of specified item on context menu, verify nonexistence of particular item on context menu, verify whether specified item is found on context menu]
---

# check context menu item not exists
