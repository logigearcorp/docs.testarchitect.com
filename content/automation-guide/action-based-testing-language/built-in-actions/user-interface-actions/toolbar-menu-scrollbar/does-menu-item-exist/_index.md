...
---
keyword: [does menu item exist, check whether specific menu item exists, verify if specified menu item is found, check for existence of specified menu item, verify existence of specified menu item]
---
