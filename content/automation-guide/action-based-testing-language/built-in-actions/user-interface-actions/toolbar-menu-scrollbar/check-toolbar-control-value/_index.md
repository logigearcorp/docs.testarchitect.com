...
---
keyword: [check toolbar control value, check displayed text of text box on toolbar against expected value, check selected value of combo box on toolbar against expected value, check if text of control matches expected value, verify whether text of control matches expected value]
---
