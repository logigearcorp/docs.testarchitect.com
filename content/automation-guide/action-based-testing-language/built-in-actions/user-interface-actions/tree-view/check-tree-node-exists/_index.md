...
---
keyword: [check tree node exists, check for existence of specified tree node, check if specific tree node exist, check whether given tree node is found, verify existence of specified tree node]
---

# check tree node exists
