...
---
keyword: [check tree node menu state, check state of specified item on menu time of tree node against expected value, check if state of specified item on menu time of tree node matches expected value, verify if state of specified item on menu time of tree node matches expected value, verify whether state of specified item on menu time of tree node matches expected value]
---

# check tree node menu state
