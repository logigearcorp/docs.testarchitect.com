...
---
keyword: [get tree node menu state, retrieve state of specified menu item on context menu of tree node, get state of specific menu on context menu of tree node]
---
