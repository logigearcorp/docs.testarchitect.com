...
description: "Description Select or clear a check box on a tree node. Arguments window TA name of the window. control TA name of the tree control. node Path to the node (see Notes ). value The status to set. ..."
weight: 15
aliases: 
    - /TA_Automation/Topics/bia_set_tree_check.html
keywords: "built-in actions, set tree check, set tree check (action), set tree check, select checkbox on tree node, clear check box on tree node"
---
...
![](/images/TA_Automation/Images/bia_set_tree_check_pgm.png)

Result

![](/images/TA_Automation/Images/bia_set_tree_check_res.png)
...
![](/images/TA_Automation/Images/bia_set_tree_check_index_aut1.png)

**Test Lines**

![](/images/TA_Automation/Images/bia_set_tree_check_index_pgm.png)

Result

![](/images/TA_Automation/Images/bia_set_tree_check_index_res.png)
