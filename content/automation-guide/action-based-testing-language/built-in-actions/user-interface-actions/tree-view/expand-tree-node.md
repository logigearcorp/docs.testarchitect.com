...
description: "Description Expand a tree node. Arguments window TA name of the window. control TA name of the tree control. node Path to the node (see Notes ). Valid contexts This action may be used within the ..."
weight: 9
aliases: 
...
![](/images/TA_Automation/Images/bia_expand_tree_node_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_expand_tree_node_res.png)
...
![](/images/TA_Automation/Images/bia_expand_tree_node_index_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_expand_tree_node_index_res.png)

**Effect**

![](/images/TA_Automation/Images/bia_expand_tree_node_index_effect.png)

## Example

**Action Lines**

![](/images/TA_Automation/Images/bia_expand_tree_node_ta4vs_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_expand_tree_node_ta4vs_res.png)
...
[collapse tree node](/automation-guide/action-based-testing-language/built-in-actions/user-interface-actions/tree-view/collapse-tree-node)
