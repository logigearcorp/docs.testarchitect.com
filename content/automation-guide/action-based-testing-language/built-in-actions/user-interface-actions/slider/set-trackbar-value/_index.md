...
keywords: "set trackbar value, set value on trackbar, set the position of slider on trackbar, set trackbar current value"
---
...
-   This action does not support setting the value of a slider control on iOS. In its place, use the [set](set.html) action in iOS.
