...
-   Use the get modal definition built-in action in combination with the [on modal action](/TA_Automation/Topics/bia_on_modal_action.html) built-in action to handle the unexpected modal dialog box properly.
...
1.  capture screenshots when the modal dialog box unexpectedly appears, using the built-in [capture screen](/TA_Automation/Topics/bia_capture_screen.html) action;
