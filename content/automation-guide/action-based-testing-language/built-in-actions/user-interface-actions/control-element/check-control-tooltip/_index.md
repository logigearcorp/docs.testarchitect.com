...
---
keyword: [check control tooltip, check control tooltip against expected string, check if control tooltip matches expected string, check whether control tooltip matches expected string]
---
