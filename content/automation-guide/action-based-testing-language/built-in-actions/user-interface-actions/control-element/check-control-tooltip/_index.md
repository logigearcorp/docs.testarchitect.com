...
keywords: "check control tooltip, check control tooltip against expected string, check if control tooltip matches expected string, check whether control tooltip matches expected string"
---
...
**Previous topic:**[check control property](/TA_Automation/Topics/bia_check_control_property.html)

**Next topic:**[check native property](/TA_Automation/Topics/bia_check_native_property.html)
