...
keywords: "check tab exists, check for existence of specified tab, check if specified tab exists, check whether specific tab exists, verify existence of specific tab"
---
