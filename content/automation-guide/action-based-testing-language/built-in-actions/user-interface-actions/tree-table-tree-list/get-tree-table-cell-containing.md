...
## {{< expand >}} Applicable Platform {{< permerlink >}} {#bia_get_table_cell_containing__section_pvr_hfr_dkb} 

Systems Applications and Products in Data Processing \(SAP\).

## {{< expand >}} Applicable Version {{< permerlink >}} {#bia_get_table_cell_containing__section_fwl_2jr_dkb} 
