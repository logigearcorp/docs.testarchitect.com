...
## {{< expand >}} Applicable Platform {{< permerlink >}} {#bia_is_cell_selected__section_pvr_hfr_dkb} 

Systems Applications and Products in Data Processing \(SAP\).

## {{< expand >}} Applicable Version {{< permerlink >}} {#bia_is_cell_selected__section_fwl_2jr_dkb} 
