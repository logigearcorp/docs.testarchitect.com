...
description: "Description Return a Boolean value to indicate whether a specified bitmap text fragment is found to exist in a given bitmap. Arguments window (Optional) TA name of the window. control (Optional) TA ..."
weight: 5
aliases: 
