--- 
title: "if text exists"
linktitle: "if text exists"
description: "Description Check for the existence of a specified bitmap text fragment in a bitmap. If the fragment is found, execute the associated action lines. Arguments window (Optional) TA name of the window. ..."
weight: 11
aliases: 
    - /TA_Automation/Topics/bia_if_text_exists.html
keywords: "built-in actions, if text exists, if text exists (action), iOS (action), Android (action), check if text exists, check whether specified text exists in area, check existence of specified text in area, verify if specified text exists in area, verify existence of specified text in area"
---

## {{< expand >}} Description

Check for the existence of a specified [bitmap text fragment](/user-guide/support/glossary-of-terms/bitmap-text-fragment) in a bitmap. If the fragment is found, execute the associated action lines.
...
## {{< expand >}} Notes {{< permerlink >}} {#bia_if_text_exists__section.notes} 
...
![](/images/TA_Automation/Images/bia_if_text_exists_aut.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_if_text_exists_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_if_text_exists_res.png)

## {{< expand >}} Example - Case 2: With rect argument specified

![](/images/TA_Automation/Images/bia_if_text_exists_aut_2.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_if_text_exists_pgm_2.png)

**Result**

![](/images/TA_Automation/Images/bia_if_text_exists_res_2.png)

## {{< expand >}} Example - Case 3: With index argument specified

![](/images/TA_Automation/Images/bia_if_text_exists_aut_3.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_if_text_exists_pgm_3.png)

**Result**

![](/images/TA_Automation/Images/bia_if_text_exists_res_3.png)

## {{< expand >}} Example - Case 4: With text color argument specified

Force a Passed checkpoint if the text is found, otherwise force a Failed.

![](/images/TA_Automation/Images/bia_if_text_exists_aut_4.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_if_text_exists_pgm_4.png)

**Result**

![](/images/TA_Automation/Images/bia_if_text_exists_res_4.png)
