...
description: "Description Check for the existence of a given bitmap text fragment within a specified area of a bitmap. Result is Passed if the text is found ; otherwise Failed . Arguments window (Optional) TA name ..."
weight: 1
aliases: 
...
![](/images/TA_Automation/Images/bia_check_text_exists_pgm.png)
...
![](/images/TA_Automation/Images/bia_check_text_exists_pgm_2.png)
...
![](/images/TA_Automation/Images/bia_check_text_exists_pgm_3.png)

**Result**

![](/images/TA_Automation/Images/bia_check_text_exists_res_3.png)

## Example - Case 4: With text color argument specified

![](/images/TA_Automation/Images/bia_check_text_exists_aut_4.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_check_text_exists_pgm_4.png)

**Result**

![](/images/TA_Automation/Images/bia_check_text_exists_res_4.png)
