...
---
keyword: [check text exists, check specified words exists within area, check if specified text exists in area, check existence of specified text in area, verify whether specified text exists in area]
---
