--- 
title: "click text"
linktitle: "click text"
description: "Description Find a given bitmapped text string in a specified area of a bitmap, and then simulate a click over the text. Arguments window (Optional) TA name of the window. control (Optional) TA name ..."
weight: 4
aliases: 
    - /TA_Automation/Topics/bia_click_text.html
keywords: "built-in actions, click text, click text (action), iOS (action), click text, Safari, iOS (action), iOS, Safari (action), Android (action), Android, Google Chrome (action), Google Chrome, Android (action), find and click given bitmapped text, click specified text in area, find given bittmapped text and click"
---

## {{< expand >}} Description

Find a given bitmapped text string in a specified area of a bitmap, and then simulate a click over the text.
...
-   **text**
    ...
    String representing the target [bitmap text fragment](/user-guide/support/glossary-of-terms/bitmap-text-fragment).

-   **index**

    \(Optional\) Specifies a particular instance of the target [bitmap text fragment](/user-guide/support/glossary-of-terms/bitmap-text-fragment), in case more than one match is expected.
...
-   **x**
    ...
    \(Optional\) Horizontal position of effective click, specified as distance in pixels from left edge of the discovered [bitmap text fragment](/user-guide/support/glossary-of-terms/bitmap-text-fragment). \(Defaults to horizontal center of the text fragment, which is also the case when x is set to 0.\)

-   **y**

    \(Optional\) Vertical position of effective click, specified as distance in pixels from top edge of the discovered [bitmap text fragment](/user-guide/support/glossary-of-terms/bitmap-text-fragment). \(Defaults to vertical center of the text fragment, which is also the case when y is set to 0.\)
...
## {{< expand >}} Notes {{< permerlink >}} {#bia_click_text__section_lgn_3ht_lk} 
...
The following settings are applicable to this action:[case sensitive](/automation-guide/action-based-testing-language/built-in-settings/value-settings/case-sensitive) \(see Notes\), [remove double quotes from cells](/automation-guide/action-based-testing-language/built-in-settings/value-settings/remove-double-quotes-from-cells), [standard ASCII only](/automation-guide/action-based-testing-language/built-in-settings/value-settings/standard-ascii-only), [object wait](/automation-guide/action-based-testing-language/built-in-settings/timing-settings/object-wait), [window wait](/automation-guide/action-based-testing-language/built-in-settings/timing-settings/window-wait).

## Example - Case 1: With window and control arguments specified

![](/images/TA_Automation/Images/bia_click_text_aut.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_click_text_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_click_text_res.png)

**Effect**

![](/images/TA_Automation/Images/bia_click_text_effect.png)

## {{< expand >}} Example - Case 2: With rect argument specified

![](/images/TA_Automation/Images/bia_click_text_aut_2.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_click_text_pgm_2.png)

**Result**

![](/images/TA_Automation/Images/bia_click_text_res_2.png)

**Effect**

![](/images/TA_Automation/Images/bia_click_text_effect.png)

## {{< expand >}} Example - Case 3: With text color argument specified

![](/images/TA_Automation/Images/bia_click_text_aut_3.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_click_text_pgm_3.png)

**Result**

![](/images/TA_Automation/Images/bia_click_text_res_3.png)
