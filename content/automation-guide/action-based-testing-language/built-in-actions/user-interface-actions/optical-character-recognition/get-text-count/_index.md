...
keywords: "get text count, count occurrences of particular text in window, count how many times specfied text occurs in control, count number of occurrences of specific text string in window or control"
---
...
![](/images//Images/bia_get_text_count_aut.png)

**Action Lines**

![](/images//Images/bia_get_text_count_pgm.png)

**Result**

![](/images//Images/bia_get_text_count_res.png)
...
**Previous topic:**[get text coordinates](/TA_Automation/Topics/bia_get_text_coordinates.html)

**Next topic:**[if text exists](/TA_Automation/Topics/bia_if_text_exists.html)
