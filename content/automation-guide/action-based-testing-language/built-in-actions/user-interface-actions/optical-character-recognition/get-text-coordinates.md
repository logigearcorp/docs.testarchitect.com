...
description: "Description Search a bitmap for a given text string and, if found, return its location. Arguments window (Optional) TA name of the window. control (Optional) TA name of the control. rect (Optional) ..."
weight: 9
aliases: 
    - /TA_Automation/Topics/bia_get_text_coordinates.html
keywords: "built-in actions, get text coordinates, get text coordinates (action), iOS (action), Android (action), get text coordinates, find position of specified text, find coordinates of specified text, locate position of specified text"
---
...
## {{< expand >}} Notes {{< permerlink >}} {#bia_get_text_coordinate__section_lgn_3ht_lk} 
...
![](/images/TA_Automation/Images/bia_get_text_coordinate_aut.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_get_text_coordinate_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_get_text_coordinate_res.png)

## {{< expand >}} Example - Case 2: With index argument specified

![](/images/TA_Automation/Images/bia_get_text_coordinate_aut_2.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_get_text_coordinate_pgm_2.png)

**Result**

![](/images/TA_Automation/Images/bia_get_text_coordinate_res_2.png)

## {{< expand >}} Example - Case 3: With text color argument specified

![](/images/TA_Automation/Images/bia_get_text_coordinate_aut_3.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_get_text_coordinate_pgm_3.png)

**Result**

![](/images/TA_Automation/Images/bia_get_text_coordinate_res_3.png)
