...
keywords: "get text content, retrieve text from control, get value returned from control, retrieve value returned from control"
---
...
![](/images//Images/bia_get_text_content_aut.png)

**Action Lines**

![](/images//Images/bia_get_text_content_pgm.png)

**Result**

![](/images//Images/bia_get_text_content_res.png)
...
**Previous topic:**[get text color](/TA_Automation/Topics/bia_get_text_color.html)

**Next topic:**[get text coordinates](/TA_Automation/Topics/bia_get_text_coordinates.html)
