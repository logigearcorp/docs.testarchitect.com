...
---
keyword: [check if text exists, check whether specified text exists in area, check existence of specified text in area, verify if specified text exists in area, verify existence of specified text in area]
---
