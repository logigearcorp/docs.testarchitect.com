...
linktitle: "get text color"
description: "Description Retrieve color code of the text fragment, in hexadecimal. Arguments window TA name of the window. control (Optional) TA name of the control. drawing function (Optional) TestArchitect ..."
weight: 7
aliases: 
    - /TA_Automation/Topics/bia_get_text_color.html
keywords: "built-in actions, get text color, get text color (action), get text forecolor, get color of specified text"
---

## Description

Retrieve color code of the text fragment, in hexadecimal.
...
![](/images/TA_Automation/Images/bia_get_text_color_aut.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_get_text_color_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_get_text_color_res.png)
