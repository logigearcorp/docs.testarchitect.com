...
Check for the nonexistence of a given [bitmap text fragment](/TA_Glossary/Topics/glossaryTextFragment.html) in a specified area of a bitmap. Result is Passed ifthe text is not found; otherwise Failed.
