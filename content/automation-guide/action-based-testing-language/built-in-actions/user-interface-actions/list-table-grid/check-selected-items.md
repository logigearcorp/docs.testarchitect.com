...
## {{< expand >}} Example - Case 1: Use text value to specify list view item
...
## {{< expand >}} Example - Case 2: Use numerical index value to specify list view item
...
## {{< expand >}} Example - Case 3: Use text value to specify list box item
...
## {{< expand >}} Example - Case 4: Use numerical index value to specify list box item
