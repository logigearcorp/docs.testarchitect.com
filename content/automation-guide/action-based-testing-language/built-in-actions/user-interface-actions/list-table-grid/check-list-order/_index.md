...
keywords: "check list order, check if all items of control are sorted, check whether all items of control are sorted, verify if all items of control are sorted, verify whether all items of control are sorted"
---
