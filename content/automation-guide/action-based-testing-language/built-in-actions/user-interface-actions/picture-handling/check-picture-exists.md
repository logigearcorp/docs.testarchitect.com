...
description: "Description Check a bitmap area of the AUT's current display for the presence of a given instance of a specified target image. Result is Passed if the picture is found ; otherwise Failed . Arguments ..."
weight: 3
aliases: 
    - /TA_Automation/Topics/bia_check_picture_exists.html
keywords: "built-in actions, check picture exists, check picture exists (action), iOS (action), check picture exists, Android (action), check if specified image is found in area, verify whether specified picture appears in area, check for specific picture in bitmap region, check if specified image is found in bitmap region"
---
...
## {{< expand >}} Notes {{< permerlink >}} {#bia_check_picture_exists__section.notes} 
...
## Example - Case 1: window and control arguments both specified

![](/images/TA_Automation/Images/bia_check_picture_exists_aut.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_check_picture_exists_pgm.png)

**Result**

![](/images/TA_Automation/Images/bia_check_picture_exists_res.png)

## {{< expand >}} Example - Case 2: rect argument specified

![](/images/TA_Automation/Images/bia_check_picture_exists_aut_2.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_check_picture_exists_pgm_2.png)

**Result**

![](/images/TA_Automation/Images/bia_check_picture_exists_res_2.png)

## {{< expand >}} Example - Case 3: index argument specified

![](/images/TA_Automation/Images/bia_check_picture_exists_aut_3.png)

**Action Lines**

![](/images/TA_Automation/Images/bia_check_picture_exists_pgm_3.png)

**Result**

![](/images/TA_Automation/Images/bia_check_picture_exists_res_3.png)
...
[check picture](/automation-guide/action-based-testing-language/built-in-actions/user-interface-actions/picture-handling/check-picture)
