...
keywords: "check picture exists, check if specified image is found in area, verify whether specified picture appears in area, check for specific picture in bitmap region, check if specified image is found in bitmap region"
---
...
![](/images//Images/bia_check_picture_exists_aut.png)

**Action Lines**

![](/images//Images/bia_check_picture_exists_pgm.png)

**Result**

![](/images//Images/bia_check_picture_exists_res.png)

## Example - Case 2: rect argument specified

![](/images//Images/bia_check_picture_exists_aut_2.png)

**Action Lines**

![](/images//Images/bia_check_picture_exists_pgm_2.png)

**Result**

![](/images//Images/bia_check_picture_exists_res_2.png)

## Example - Case 3: index argument specified

![](/images//Images/bia_check_picture_exists_aut_3.png)

**Action Lines**

![](/images//Images/bia_check_picture_exists_pgm_3.png)

**Result**

![](/images//Images/bia_check_picture_exists_res_3.png)
