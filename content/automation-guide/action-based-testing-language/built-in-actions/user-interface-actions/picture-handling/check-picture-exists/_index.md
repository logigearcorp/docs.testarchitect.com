...
---
keyword: [check picture exists, check if specified image is found in area, verify whether specified picture appears in area, check for specific picture in bitmap region, check if specified image is found in bitmap region]
---
