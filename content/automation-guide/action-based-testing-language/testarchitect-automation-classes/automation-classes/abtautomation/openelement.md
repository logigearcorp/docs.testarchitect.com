...
## {{< expand >}} Syntax {{< permerlink >}} {#abt_OpenElement__section.syntax} 

`AbtElement openElement (string window, string control)`

## {{< expand >}} Description {{< permerlink >}} {#abt_OpenElement__section.desc} 

Opens a control.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_OpenElement__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_OpenElement__section.return} 
