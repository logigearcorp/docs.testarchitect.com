...
## {{< expand >}} Description {{< permerlink >}} {#abt_DoesItemExist_combobox__section.desc} 

Determine whether an item with the specified text exists in the control's list.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_DoesItemExist_combobox__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_DoesItemExist_combobox__section.return} 
