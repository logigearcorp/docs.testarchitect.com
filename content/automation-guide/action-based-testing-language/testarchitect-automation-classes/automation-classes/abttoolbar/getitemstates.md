...
## {{< expand >}} Description {{< permerlink >}} {#abt_GetItemStates__section.desc} 

Retrieve the current state\(s\) of an item in the toolbar.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_GetItemStates__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_GetItemStates__section.return} 
