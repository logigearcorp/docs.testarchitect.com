...
description: "Syntax string getTextContent (string drawfunction, string text, int index) Description Retrieve content of the text fragment residing in a given window. Parameters drawfunction TestArchitect detects ..."
weight: 19
aliases: 
    - /TA_Automation/Topics/abt_AbtGetTextContent_AbtEntity.html
keywords: "methods of abt, GetTextContent, GetTextContent (AbtEntity), AbtEntity, gettextcontent, abtentity gettextcontent, get content of text in window, obtain text"
---

## {{< expand >}} Syntax {{< permerlink >}} {#abt_GetTextContent_AbtEntity__section.syntax} 

`string getTextContent (string drawfunction, string text, int index)`

## {{< expand >}} Description {{< permerlink >}} {#abt_GetTextContent_AbtEntity__section.desc} 

Retrieve content of the text fragment residing in a given window.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_GetTextContent_AbtEntity__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_GetTextContent_AbtEntity__section.return} 

A string value indicating content of the text.

## {{< expand >}} Notes {{< permerlink >}} {#abt_GetTextContent_AbtEntity__section_vwj_hjw_j4} 
