...
## {{< expand >}} Syntax {{< permerlink >}} {#abt_Maximize_AbtEntity__section.syntax} 

`int getTextCount (string drawfunction, string text)`

## {{< expand >}} Description {{< permerlink >}} {#abt_Maximize_AbtEntity__section.desc} 

Retrieve a count of the total number of text fragments residing in a given window.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_Maximize_AbtEntity__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_Maximize_AbtEntity__section.return} 

An integer value indicating the total number of text fragments found.

## {{< expand >}} Notes {{< permerlink >}} {#abt_Maximize_AbtEntity__section_vwj_hjw_j4} 
