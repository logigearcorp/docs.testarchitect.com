...
description: "Syntax string GetTextBackgroundColor (string drawfunction, string text, int index) Description Retrieve color code of the text background residing in a given window, in hexadecimal. Parameters ..."
weight: 17
aliases: 
    - /TA_Automation/Topics/abt_AbtGetTextBackgroundColor_AbtEntity.html
keywords: "methods of abt, GetTextBackgroundColor, GetTextBackgroundColor (AbtEntity), AbtEntity, gettextbackgroundcolor, abtentity gettextbackgroundcolor, color code of text background in window, get backcolor of text in window, hexadecimal color code of text background in window"
---

## {{< expand >}} Syntax {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtEntity__section.syntax} 

`string GetTextBackgroundColor (string drawfunction, string text, int index)`

## {{< expand >}} Description {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtEntity__section.desc} 

Retrieve color code of the text background residing in a given window, in hexadecimal.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtEntity__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtEntity__section.return} 

A hexadecimal value indicating color code of the text background.

## {{< expand >}} Notes {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtEntity__section.note} 
