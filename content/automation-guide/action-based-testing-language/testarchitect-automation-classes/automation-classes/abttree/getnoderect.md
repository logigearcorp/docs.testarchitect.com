...
## {{< expand >}} Description {{< permerlink >}} {#abt_GetNodeRect__section.desc} 

Retrieve the bounding rectangle of a specified node in the tree control.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_GetNodeRect__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_GetNodeRect__section.return} 
