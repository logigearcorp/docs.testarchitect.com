...
## {{< expand >}} Description {{< permerlink >}} {#abt_SetNodeStates__section.desc} 

Set the state of a check box icon of the specified node in a tree view control.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_SetNodeStates__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_SetNodeStates__section.return} 
