...
## {{< expand >}} Description {{< permerlink >}} {#abt_ScrollIntoView__section.desc} 

Ensure a tree node is visible by, if necessary, scrolling it into view.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_ScrollIntoView__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_ScrollIntoView__section.return} 
