...
## {{< expand >}} Description {{< permerlink >}} {#abt_GetItemRect_Tab__section.desc} 

Retrieve the bounding rectangle of a specified tab item.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_GetItemRect_Tab__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_GetItemRect_Tab__section.return} 
