...
## {{< expand >}} Syntax {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtElement__section.syntax} 

`string GetTextBackgroundColor (string drawfunction, string text, int index)`

## {{< expand >}} Description {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtElement__section.desc} 

Retrieve color code of the text background residing in a given control, in hexadecimal.

## {{< expand >}} Parameters {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtElement__section.params} 
...
## {{< expand >}} Return Value {{< permerlink >}} {#abt_GetTextBackgroundColor_AbtElement__section.return} 
