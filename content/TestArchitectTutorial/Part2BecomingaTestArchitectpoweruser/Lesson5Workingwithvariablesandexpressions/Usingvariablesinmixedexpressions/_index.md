...
---
# Using variables in mixed expressions {#Using_variables_in_mixed_expressions .task}
...
6.  Move your cell pointer a few rows past the last local variable line, and press Ctrl+V to paste.
    ...
    ![](../Images/tut.Vars_and_Exps.Mixed_Expr_Var_01.Test.png)
...
![](../Images/tut.Vars_and_Exps.Mixed_Expr_Var_01.Results.png)
...
**Previous topic:**[Working with mixed types](../../TA_Tutorials/Topics/Working_with_mixed_types.html)

**Next topic:**[Wildcards](../../TA_Tutorials/Topics/Wildcards.html)
