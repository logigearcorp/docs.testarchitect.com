...
---
# Working with mixed types {#Working_with_mixed_types .task}
...
3.  Add another report action that combines both string and numeric operations, on both types of operand:
    ...
    ![](../Images/tut.Vars_and_Exps.Mixed_Expr_01.Test.png)
...
![](../Images/tut.Vars_and_Exps.Mixed_Expr_01.Results.png)
