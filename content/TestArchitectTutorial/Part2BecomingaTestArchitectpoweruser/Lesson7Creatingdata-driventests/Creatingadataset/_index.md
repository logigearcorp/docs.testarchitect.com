...
---
# Creating a data set {#Creating_a_data_set .task}
...
3.  In the editor, beginning with cell **B4**, type the header values rental month, model rented, pickup state and quantity rented, as shown in the [table](Creating_a_data_set.md#tut7_data_set01) below.
...
6.  Click **Save** ![](../../reuse/../TA_Tutorials/Images/btn.TAC_toolbar.SaveFile.png) on the toolbar.


Your data set is now complete and should resemble the following:

![](../Images/tut.Data_Sets.Rented_Cars_DS.png)
