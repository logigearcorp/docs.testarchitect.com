...
---
# Creating the test case and stub action {#Creating_the_test_case_and_stub_action_1_COPY .task}
...
3.  Assuming you performed the last exercise, you should have a test module named My scripted tests. If not, go ahead and[create it.](../../reuse/../TA_Tutorials/Topics/Creating_the_test_case_and_stub_action.md#stepsection.harness.python.create_tm)
...
6.  In your new test case, and an action line to invoke the action with some real data:
    ...
    ![](../../reuse/../TA_Tutorials/Images/tut.Harness.Test03.png)
