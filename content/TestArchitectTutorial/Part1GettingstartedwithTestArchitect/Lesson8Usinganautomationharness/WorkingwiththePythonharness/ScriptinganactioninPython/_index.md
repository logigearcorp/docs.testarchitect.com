...
---
# Scripting an action in Python {#Scripting_an_action_Python .task}
...
You are going to implement an action named hello in thePythonharness. It will accept one argument, who, and write out the word hello, followed by the value specified for who: ![](../../reuse/../TA_Tutorials/Images/Python_hello_demo.png)
...
3.  Add an additional SetActionScript\(\) line to the SetActions\(\) function of mod\_Example.py, as shown:
    ...
    ![](../Images/tut.Harness.mod_py_file.SetActionScript01.png)
...
5.  Add an else-if \(`elif`\) clause to the `if`-statement in the module’s Divert\(\) function:
    ...
    ![](../Images/tut.Harness.mod_py_file.Add_elif01.png)
