...
---
# Creating a case for looping {#Creating_loops .task}
...
9.  Modify the value argument of the third local variable action for car price to `25000`, then modify the next one to `30000`.
    ...
    ![](../Images/tut.Reusability.Test01.png)
...
10. With your test module displayed in the TestArchitect editor, click **Execute** ![](../../reuse/../TA_Tutorials/Images/btn.TAC_toolbar.Execute.png) on the toolbar.
...
![](../Images/tut.Reusability.Test01_Results.png)
