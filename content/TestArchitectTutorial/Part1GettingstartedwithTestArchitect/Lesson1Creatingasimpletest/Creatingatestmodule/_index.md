...
---
# Creating a test module {#Creating_a_test_module .task}
...
4.  In the TestArchitect explorer tree, select any item within the current project, then click **Create new test module** ![](../../reuse/../TA_Tutorials/Images/btn.TAC_toolbar.CreateTestModule.png) in the toolbar.
...
6.  Click **Create**.
    ...
    ![](../Images/tut.Simple_Tests.creating01.PNG)
...
10. Select cell **C14** \(one cell to the right\) and enter Say hello to the world as the short description for this test case.
    ...
    ![](../Images/tut.Simple_Tests.creating03.PNG)
...
14. Select cell **B18** and type hello world. Press Enter.
    ...
    ![](../Images/tut.Simple_Tests.creating04.PNG)
