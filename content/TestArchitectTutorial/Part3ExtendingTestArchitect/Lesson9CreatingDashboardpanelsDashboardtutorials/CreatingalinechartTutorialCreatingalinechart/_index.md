...
---
# Creating a line chartTutorial: Creating a line chart {#tutDashboard_line_chart .task}
...
2.  Create a new Dashboard panel with the following settings:
    ...
    2.  In the Add New Panel dialog, enter the values as specified above, and click **OK**.
        ...
        ![](../Images/tut.Dashboard.Add_New_Panel.Car_Rental.Trend.Line_chart.01.png)
    ...
    ![](../Images/tut.Dashboard.line_chart.Car_Rental.results_trend.01.png)
