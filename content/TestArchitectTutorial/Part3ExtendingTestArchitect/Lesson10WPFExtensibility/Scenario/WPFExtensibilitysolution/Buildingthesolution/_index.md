...
---
# Building the solution {#task_etm_m13_jm .task}
...
2.  Select **Build** from the context menu.
    ...
    The DLL file will be created in the location you specified for the WpfExtensionSample project in the [earlier step](WPF_Extensibility_solution_creating.md#step_z5w_p23_jm).
