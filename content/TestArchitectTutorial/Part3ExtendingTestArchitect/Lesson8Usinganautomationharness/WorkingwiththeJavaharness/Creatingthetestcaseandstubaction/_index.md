...
---
# Creating the test case and stub action {#Creating_the_test_case_and_stub_action_Java .task}
...
3.  Enter hello as the action name, and who as the name of its sole argument:
    ...
    ![](../../reuse/../TA_Tutorials/Images/tut.Harness.New_Action_dlg.who.png)
...
5.  In the TestArchitect explorer tree, select any item within the current project, then click **Create new test module** ![](../../reuse/../TA_Tutorials/Images/btn.TAC_toolbar.CreateTestModule.png) in the toolbar.
...
8.  Now you can begin to write an action line to call your new user-scripted action:
    ...
    ![](../Images/tut.Harness.Test02.java.png)

9.  Click **Save** ![](../../reuse/../TA_Tutorials/Images/btn.TAC_toolbar.SaveFile.png) on the toolbar.
...
**Previous topic:**[Scripting an action in Java](../../TA_Tutorials/Topics/Scripting_an_action_Java.html)

**Next topic:**[Running a Java harness test](../../TA_Tutorials/Topics/Running_the_test_4_Java.html)
