...
---
# Running a Java harness test {#Running_the_test_4_Java .task}
...
4.  Click ![](../../reuse/../TA_Help/Images/btn.browse-ellipsis.02.png) next to the **Script\(s\)** field to browse to the filejava\_harness.jar which, if you followed the instructions to create it \(that is, used Eclipse\), should be in your Eclipse workspace directory.
...
![](../Images/tut.Harness.Test02_Results.Java.png)
