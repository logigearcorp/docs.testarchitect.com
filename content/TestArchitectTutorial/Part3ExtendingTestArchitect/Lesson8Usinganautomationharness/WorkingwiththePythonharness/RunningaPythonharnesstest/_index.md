...
---
# Running a Python harness test {#Running_the_test_4_Python .task}
...
4.  Click ![](../../reuse/../TA_Help/Images/btn.browse-ellipsis.02.png) next to the **Script\(s\)** field to browse to the fileta\_main.py.
...
![](../../reuse/../TA_Tutorials/Images/tut.Harness.Test02_Results.Python.png)
