...
![](/images//Images/search_autocomplete.png)
...
![](/images//Images/search_page.png)

When you click on a result, the topic is opened and the search results are highlighted.

![](/images//Images/search_page_selected.png)

**Tip:** If you want to remove the colored highlights, click the **Toggle Highlights** \(![](/images//Images/toggle_btn.png)\) button at the top-right side of the page.
...
![](/images//Images/stars_sorting.png)
...
![](/images//Images/missing_terms.png)
