...
---
# Testing web applications {#web_automation .concept}
...
-   **Windows**:
    ...
    -   Google Chrome, up to version 79.
    -   Mozilla Firefox, up to version 71
        -   GeckoDriver version [0.24.0](https://github.com/mozilla/geckodriver/releases)
-   **Linux**:
...
## Client and server-side technologies {#section_ipl_bzc_m4 .section}
...
## Test machine and web browser configuration { .section}
