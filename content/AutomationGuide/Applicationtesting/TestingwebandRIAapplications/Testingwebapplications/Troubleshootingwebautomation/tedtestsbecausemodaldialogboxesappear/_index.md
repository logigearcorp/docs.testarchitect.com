...
---
# Google Chrome: Unable to identify web controls or run automated tests because modal dialog boxes appear {#reference_zlf_kmz_jy .reference}

## Problem {#section_amc_bnz_jy .section}
...
## Solution {#section_bmc_bnz_jy .section}
