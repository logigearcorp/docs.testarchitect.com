...
---
# How to capture UI controls on Mozilla Firefox and Microsoft Edge? {#reference_jkd_hpp_pz .reference}
...
2.  Identify the property value of desired UI controls.
    -   Microsoft Edge and Mozilla Firefox: Activate the **node picker** by clicking its icon ![](../Images/select_element_icon_FF.png). After that, as you move the mouse around the HTML page, the UI control under the mouse is highlighted. Click the UI control to select it.

        ![](../Images/developer_tools_ME.png)

        ![](../Images/developer_tools_FF.png)
