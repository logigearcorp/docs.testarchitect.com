...
---
# Testing Java applications - Overview {#concept_dhs_2nc_14 .concept}
...
## Creating and recording tests for Java applications { .section}
...
## Actions supported for Java controls { .section}
...
## Java control identification { .section}
...
![](../../reuse/../TA_Automation/Images/aut_interface_definition_UI_Java_identification.png)

## Native Java properties { .section}
...
![](../../reuse/../TA_Automation/Images/aut_interface_definition_Java_Native_properties.png)

**Parent topic:**[Testing Java applications](../../TA_Automation/Topics/aut_app_testing_Java_apps.html)

**Next topic:**[Supported Java technologies](../../TA_Automation/Topics/aut_app_testing_Java_apps_supported_technology.html)
