...
---
# Testing WPF applications - Overview {#concept_dtf_ncj_14 .concept}
...
## Creating and recording tests for WPF applications { .section}
...
## Actions supported for WPF controls { .section}
...
## WPF control identification { .section}
...
![](../../reuse/../TA_Automation/Images/aut_interface_definition_UI_WPF_identification.png)

## Native WPF properties { .section}
...
![](../../reuse/../TA_Automation/Images/aut_interface_definition_WPF_Native_properties.png)

## The UIA Support tool { .section}
...
**Next topic:**[Supported WPF technologies](../../TA_Automation/Topics/aut_app_testing_WPF_apps_supported_technology.html)
