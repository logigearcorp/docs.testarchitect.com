...
---
# Running automated tests on multiple mobile devices {#task_zd2_zwz_b4 .task}
...
1.  Select the test module you want to run, and then click **Execute** ![](../Images/btn.TAC_toolbar.Execute.png) on the TestArchitect toolbar.
...
3.  In the Controllers/Devices panel of the Select Controller/Device dialog box, expand the root node, and select those mobile devices on which you want to execute the automated test.
    ...
    ![](../Images/Select_multiple_mobile_devices.png)
