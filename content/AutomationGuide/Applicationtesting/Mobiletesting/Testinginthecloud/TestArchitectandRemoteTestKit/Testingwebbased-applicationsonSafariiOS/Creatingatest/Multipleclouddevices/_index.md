...
---
# Selecting multiple cloud devices at launch time {#task_dmh_ws4_r1b .task}
...
The automated tests are run on target cloud devices. On test results, you will also see the name of the cloud device and the full path to JSON file, which defines target cloud devices. ![](../Images/result_RTK_multiple_cloud_devices.png)
