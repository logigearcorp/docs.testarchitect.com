...
---
# TestArchitect is unable to select the specified item. Please check the *<itemName\>* item in the *<controlName\>* control, which resides in the *<windowName\>* window, is not disabled. {#reference_0x80010409L .reference}
