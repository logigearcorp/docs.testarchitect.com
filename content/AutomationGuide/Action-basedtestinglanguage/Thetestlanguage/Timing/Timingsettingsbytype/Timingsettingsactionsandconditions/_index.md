...
---
# Timing settings, actions and conditions {#timing_settings_actions_conditions .concept}
...
**Note:** See [the table](timing_summary.md#imgtbl_summary_actions_timesettings_results) in [the summary](timing_summary.html) for a more detailed look at the relationships between action types, timing settings, preconditions, conditions, and results.

![](../Images/timing_tbl_action_types-time_settings-results.png)
