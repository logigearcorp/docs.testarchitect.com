...
---
# Configuring WebDriver server & client {#WebDriver_server_client .reference}
...
## Method \#1: Via the **Automation Agent Manager** dialog box. {#section_nnt_nc3_wfb .section}
...
4.  In the TestArchitect Automation Agent dialog box, click the **Configure** button corresponding to the browser.
    ...
    ![](../Images/WebDriver_Automation_Agent_Manager_dlg.png)

5.  In the WebDriver Configuration dialog box,

    ![](../Images/WebDriver_Configuration_dlg.png)
...
## Method \#2: Via the server/client key defined in the configure webdriver built-in action {#section_b2v_l23_wfb .section}

Only when you need an advanced test environment, should you adopt this method.

![](../Images/WebDriver_configure_server.png)

![](../Images/WebDriver_configure_client.png)
