...
---
# Re-signing and installing TestArchitect Browser Agent {#task_e5k_23c_vp .task}
...
6.  Connect the iOS device to the test machine using a USB cable, and install the re-signed TestArchitectBrowserAgent onto the device via iTunes.
    ...
    **Note:** You can perform step [6](aut_app_testing_mobile_web_Safari_installing_TA_Browser_Agent.md#step_u4p_xyq_kn) on either an macOS or Windows machine.
