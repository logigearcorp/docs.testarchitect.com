...
---
# does context menu item exist {#bia_does_context_menu_item_exist .reference}
...
![](../Images/bia_does_context_menu_item_exist_aut.png)

**Action Lines**

![](../Images/bia_does_context_menu_item_exist_pgm.png)

**Result**

![](../Images/bia_does_context_menu_item_exist_res.png)

## Example - Case 2: Use numerical index value { .section}

![](../Images/bia_does_context_menu_item_exist_index_aut.png)

**Action Lines**

![](../Images/bia_does_context_menu_item_exist_index_pgm.png)

**Result**

![](../Images/bia_does_context_menu_item_exist_index_res.png)
...
![](../Images/bia_does_context_menu_item_exist_ta4vs_pgm.png)

**Result**

![](../Images/bia_does_context_menu_item_exist_ta4vs_res.png)
