...
---
# get picture location {#bia_get_picture_location .reference}
...
![](../Images/bia_get_picture_location_aut.png)

**Action Lines**

![](../Images/bia_get_picture_location_pgm.png)

**Result**

![](../Images/bia_get_picture_location_res.png)

## Example - Case 2: The rect argument is specified { .section}

![](../Images/bia_get_picture_location_aut_3.png)

**Action Lines**

![](../Images/bia_get_picture_location_pgm_3.png)

**Result**

![](../Images/bia_get_picture_location_res_3.png)

## Example - Case 3: The index argument is specified { .section}

![](../Images/bia_get_picture_location_aut_2.png)

**Action Lines**

![](../Images/bia_get_picture_location_pgm_2.png)

**Result**

![](../Images/bia_get_picture_location_res_2.png)

**Parent topic:**[Picture Handling](../../TA_Automation/Topics/bia_picture_handling.html)

**Previous topic:**[get baseline image count](../../TA_Automation/Topics/bia_get_baseline_image_count.html)

**Next topic:**[if picture exists](../../TA_Automation/Topics/bia_if_picture_exists.html)
