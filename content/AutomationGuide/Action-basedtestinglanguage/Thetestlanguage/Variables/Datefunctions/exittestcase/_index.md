...
---
# exit test case {#bia_exit_test_case .reference}
...
## Arguments {#section_arguments .section}
...
## Example - Case 1: Exit status is Incomplete { .section}

**Action Lines**

![](../Images/bia_exit_test_case_pgm.png)

**Result**

When exit test case with the value of Incomplete is executed, the overall status of this test result is Not Finished.

![](../Images/bia_exit_test_case_res_exit_status_incomplete.png)

## Example - Case 2: Exit status is Complete { .section}

**Action Lines**

![](../Images/bia_exit_test_case_complete_pgm.png)
...
![](../Images/bia_exit_test_case_res_exit_status_complete.png)
