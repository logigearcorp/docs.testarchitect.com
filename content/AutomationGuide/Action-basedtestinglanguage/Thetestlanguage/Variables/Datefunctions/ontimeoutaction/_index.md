...
---
# on timeout action {#bia_on_timeout_action .reference}

## Description {#section_lgr_mjf_4cb .section}
...
## Arguments {#section_mgr_mjf_4cb .section}
...
## Valid contexts {#section_ngr_mjf_4cb .section}

This action may be used within the following project items:test modules and user-defined actions.

## Notes {#section_ogr_mjf_4cb .section}
...
## Applicable Built-In Settings {#section_qgr_mjf_4cb .section}

The following settings are applicable to this action:[remove double quotes from cells](bis_remove_double_quotes_from_cells.html).

## Example - Case 1: Timeout handler with no arguments {#section_rgr_mjf_4cb .section}

**Action Lines**

![](../Images/bis_on_timeout_action_pgm.png)

## Example - Case 2: Timeout handler with arguments {#section_ugr_mjf_4cb .section}

**Action Lines**

![](../Images/bis_on_timeout_action_pgm_2.png)
