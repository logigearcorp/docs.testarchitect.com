...
---
# check context menu item not exists {#bia_check_context_menu_item_not_exists .reference}
...
![](../Images/bia_check_context_menu_item_not_exists_aut.png)

**Action Lines**

![](../Images/bia_check_context_menu_item_not_exists_pgm.png)

**Result**

![](../Images/bia_check_context_menu_item_not_exists_res.png)

## Example - Case 2: Use numerical index value { .section}

![](../Images/bia_check_context_menu_item_not_exists_index_aut.png)

**Action Lines**

![](../Images/bia_check_context_menu_item_not_exists_index_pgm.png)

**Result**

![](../Images/bia_check_context_menu_item_not_exists_index_res.png)
...
![](../Images/bia_check_context_menu_item_not_exists_ta4vs_pgm.png)

**Result**

![](../Images/bia_check_context_menu_item_not_exists_ta4vs_res.png)
