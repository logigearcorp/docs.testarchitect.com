--- 
title: "check picture not exists"
linktitle: "check picture not exists"
aliases: 
    - /TA_Automation/Topics/bia_check_picture_not_exists.html
---
# check picture not exists {#bia_check_picture_not_exists .reference}
...
![](../Images/bia_check_picture_not_exists_aut.png)

**Action Lines**

![](../Images/bia_check_picture_not_exists_pgm.png)

**Result**

![](../Images/bia_check_picture_not_exists_res.png)

## Example - Case 2: The rect argument is specified { .section}

![](../Images/bia_check_picture_not_exists_aut_2.png)

**Action Lines**

![](../Images/bia_check_picture_not_exists_pgm_2.png)

**Result**

![](../Images/bia_check_picture_not_exists_res_2.png)

## Example - Case 3: The index argument is specified { .section}

![](../Images/bia_check_picture_not_exists_aut_3.png)

**Action Lines**

![](../Images/bia_check_picture_not_exists_pgm_3.png)

**Result**

![](../Images/bia_check_picture_not_exists_res_3.png)

**Parent topic:**[Picture Handling](../../TA_Automation/Topics/bia_picture_handling.html)

**Previous topic:**[check picture exists](../../TA_Automation/Topics/bia_check_picture_exists.html)

**Next topic:**[click picture](../../TA_Automation/Topics/bia_click_picture.html)
