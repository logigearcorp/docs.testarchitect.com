...
---
# check menu item exists {#bia_check_menu_item_exists .reference}
...
![](../Images/bia_check_menu_item_exists_aut_1.png)

**Action Lines**

![](../Images/bia_check_menu_item_exists_pgm_1.png)

**Result**

![](../Images/bia_check_menu_item_exists_res_1.png)

## Example - Case 2: Item on menu of a Java application { .section}

![](../Images/bia_check_menu_item_exists_aut.png)

**Action Lines**

![](../Images/bia_check_menu_item_exists_pgm.png)

**Result**

![](../Images/bia_check_menu_item_exists_res.png)

## Example - Case 1: Item on main menu of a Windows application { .section}

![](../Images/bia_check_menu_item_exists_ta4vs_aut_1.png)

**Action Lines**

![](../Images/bia_check_menu_item_exists_ta4vs_pgm_1.png)

**Result**

![](../Images/bia_check_menu_item_exists_ta4vs_res_1.png)

## Example - Case 2: Item on menu of a WPF application { .section}

![](../Images/bia_check_menu_item_exists_ta4vs_aut_2.png)

**Action Lines**

![](../Images/bia_check_menu_item_exists_ta4vs_pgm_2.png)

**Result**

![](../Images/bia_check_menu_item_exists_ta4vs_res_2.png)
