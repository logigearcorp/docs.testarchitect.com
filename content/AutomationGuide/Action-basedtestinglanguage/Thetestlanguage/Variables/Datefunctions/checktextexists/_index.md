--- 
title: "check text exists"
linktitle: "check text exists"
aliases: 
    - /TA_Automation/Topics/bia_check_text_exists.html
---
# check text exists {#bia_check_text_exists .reference}

## Description { .section}

Check for the existence of a given [bitmap text fragment](../../TA_Glossary/Topics/glossaryTextFragment.html) within a specified area of a bitmap. Result is Passed ifthe text is found; otherwise Failed.

## Arguments {#section_ict_qgt_lk .section}
...
![](../Images/bia_check_text_exists_pgm.png)

**Result**

![](../Images/bia_check_text_exists_res.png)

## Example - Case 2: With rect argument specified { .section}

![](../Images/bia_check_text_exists_aut_2.png)

**Action Lines**

![](../Images/bia_check_text_exists_pgm_2.png)

**Result**

![](../Images/bia_check_text_exists_res_2.png)

## Example - Case 3: With index argument specified { .section}

![](../Images/bia_check_text_exists_aut_3.png)

**Action Lines**

![](../Images/bia_check_text_exists_pgm_3.png)

**Result**

![](../Images/bia_check_text_exists_res_3.png)

## Example - Case 4: With text color argument specified { .section}

![](../Images/bia_check_text_exists_aut_4.png)

**Action Lines**

![](../Images/bia_check_text_exists_pgm_4.png)

**Result**

![](../Images/bia_check_text_exists_res_4.png)

**Parent topic:**[Optical Character Recognition](../../TA_Automation/Topics/bia_OCR.html)

**Next topic:**[check text not exists](../../TA_Automation/Topics/bia_check_text_not_exists.html)
