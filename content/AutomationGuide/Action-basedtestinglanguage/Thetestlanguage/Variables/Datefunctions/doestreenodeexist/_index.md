...
---
# does tree node exist {#bia_does_tree_node_exist .reference}
...
![](../Images/bia_does_tree_node_exist_aut.png)

**Action Lines**

![](../Images/bia_does_tree_node_exist_pgm.png)

**Result**

![](../Images/bia_does_tree_node_exist_res.png)

## Example - Case 2: Using a numerical index for node path { .section}

![](../Images/bia_does_tree_node_exist_index_aut.png)

**Action Lines**

![](../Images/bia_does_tree_node_exist_index_pgm.png)

**Result**

![](../Images/bia_does_tree_node_exist_index_res.png)
...
![](../Images/bia_does_tree_node_exist_ta4vs_pgm.png)

**Result**

![](../Images/bia_does_tree_node_exist_ta4vs_res.png)
