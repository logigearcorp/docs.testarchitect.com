...
---
# List of supported Safari macOS actions {#ios_reference_d3h_3rl_n4 .reference}
...
|Controls, Elements|[check](bia_check.html)
 ...
 [wait for property](bia_wait_for_property.html)

|
|Mouse|[click](bia_click.html)
...
|
|Text box|[check pattern in text](bia_check_pattern_in_text.html)

 [check pattern not in text](bia_check_pattern_not_in_text.html)

 [check text line](bia_check_text_line.html)

 [get text line](bia_get_text_line.html)

|
|Media|[play](bia_html5_audio_video_play.html)

 [pause](bia_html5_audio_video_pause.html)

 [set volume](bia_html5_audio_video_set_volume.html)

 [set media property](bia_html5_audio_video_set_media_property.html)

|
|JavaScript popup|[check popup default text](bia_check_popup_default_text.html)
...
|Window|[check controls matched](bia_check_controls_matched.html)
 ...
 [close window property](bia_close_window.html)

 [does window exist](bia_does_window_exist.html)

 [focus window](bia_focus_window.html)

 [get window property](bia_get_window_property.html)

 [identify windows](bia_identify_windows.html)

 [if window exists](bia_if_window_exists.html)

 [if window not exists](bia_if_window_not_exists.html)

 [maximize](bia_maximize.html)

 [minimize](bia_minimize.html)

 [move window](bia_move_window.html)

 [resize window](bia_resize_window.html)

 [restore window](bia_restore_window.html)

 [wait for window](bia_wait_for_window.html)

 [wait for window close](bia_wait_for_window_close.html)
