...
---
# check item exists {#bia_check_item_exists .reference}
...
![](../Images/bia_check_item_exist_aut.png)

**Action Lines**

![](../Images/bia_check_item_exists_pgm.png)

**Result**

![](../Images/bia_check_item_exist_res.png)

## Example - Case 2: Use numerical index value to specify list box item { .section}

![](../Images/bia_check_item_exist_index_aut.png)

**Action Lines**

![](../Images/bia_check_item_exists_index_pgm.png)

**Result**

![](../Images/bia_check_item_exist_index_res.png)

## Example - Case 3: Use text value to specify list view item { .section}

![](../Images/bia_check_item_exist_2_aut.png)

**Action Lines**

![](../Images/bia_check_item_exists_2_pgm.png)

**Result**

![](../Images/bia_check_item_exist_2_res.png)

## Example - Case 4: Use numerical index value to specify list view item { .section}

![](../Images/bia_check_item_exist_2_index_aut.png)

**Action Lines**

![](../Images/bia_check_item_exists_2_index_pgm.png)

**Result**

![](../Images/bia_check_item_exist_2_index_res.png)
...
![](../Images/bia_check_item_exists_ta4vs_pgm.png)

**Result**

![](../Images/bia_check_item_exist_ta4vs_res.png)
