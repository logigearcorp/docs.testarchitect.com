...
---
# check context menu item state {#bia_check_context_menu_item_state .reference}
...
## Example - Case 1: Using a text value { .section}

![](../Images/bia_check_context_menu_item_state_aut.png)

**Action Lines**

![](../Images/bia_check_context_menu_item_state_pgm.png)

**Result**

![](../Images/bia_check_context_menu_item_state_res.png)

## Example - Case 2: Using a numerical index value { .section}

![](../Images/bia_check_context_menu_item_state_index_aut.png)

**Action Lines**

![](../Images/bia_check_context_menu_item_state_index_pgm.png)

**Result**

![](../Images/bia_check_context_menu_item_state_index_res.png)
