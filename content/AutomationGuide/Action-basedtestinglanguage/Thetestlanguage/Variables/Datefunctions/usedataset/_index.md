...
---
# use data set {#bia_use_data_set .reference}
...
![](../Images/bia_use_data_set_pgm.png)

## Example - Case 2: Inline data sets { .section}

**Action Lines**

![](../Images/bia_use_data_set_inline_pgm.png)

## Example - Case 1: Dedicated data sets { .section}

**Action Lines**

![](../Images/bia_use_data_set_ta4vs_pgm.png)

## Example - Case 2: Inline data sets { .section}

**Action Lines**

![](../Images/bia_use_data_set_inline_ta4vs_pgm.png)
