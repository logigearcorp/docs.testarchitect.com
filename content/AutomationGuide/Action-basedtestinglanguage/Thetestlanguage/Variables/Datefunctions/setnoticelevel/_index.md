...
---
# set notice level {#bia_set_notice_level .reference}
...
-   This action sets the value of the [notice level](bis_notice_level.html) built-in setting. Note that the same effect can be achieved by using the [setting](bia_setting.html) action with notice level.
...
![](../Images/bia_set_notice_level_pgm.png)

**Result**

![](../Images/bia_set_notice_level_res.png)
