...
---
# set data set value {#bia_set_data_set_value .reference}
...
## Example - Case 1: using the row argument { .section}
...
![](../Images/bia_set_data_set_value_aut.png)

**Action Lines**

![](../Images/bia_set_data_set_value_pgm.png)

**Result**

![](../Images/bia_set_data_set_value_res.png)

**Effect**

![](../Images/bia_set_data_set_value_effect.png)

## Example - Case 2: using the criterion argument { .section}
...
![](../Images/bia_set_data_set_value_aut_2.png)

**Action Lines**

![](../Images/bia_set_data_set_value_pgm_2.png)

**Result**

![](../Images/bia_set_data_set_value_res_2.png)

**Effect**

![](../Images/bia_set_data_set_value_effect_2.png)
