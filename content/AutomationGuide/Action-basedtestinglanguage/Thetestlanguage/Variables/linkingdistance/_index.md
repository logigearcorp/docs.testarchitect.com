...
---
# linking distance {#bis_ignore_html_input_types .reference}

## Description { .section}

In [OCR actions](bia_OCR.html), specifies the maximum horizontal distance between adjacent characters for those characters to be treated as members of a single [bitmap text fragment](../../TA_Glossary/Topics/glossaryTextFragment.html).
...
-   linking distance can also be set through the dedicated [set ocr setting](bia_set_ocr_setting.html) action, as well as through the [setting](bia_setting.html) action.
-   For ease of use, this value can be derived with the [OCR Detector Tool](../../TA_Help/Topics/ug_OCR_detector_tool_advanced_settings.md#li_fnx_2rl_ms), which allows you to establish the optimum settings for the detection of text under difficult circumstances.
