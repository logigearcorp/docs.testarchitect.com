...
---
# click delay {#bis_click_delay .reference}
...
This built-in setting is only in effect when the value of built-in setting [click method](bis_click_method.html) is set to [separate sendinput messages](bis_click_method.md#plentry.separate_sendinput_messages).
...
-   The click delay setting is only in effect when the value of built-in setting [click method](bis_click_method.html) is set to [separate sendinput messages](bis_click_method.md#plentry.separate_sendinput_messages). This setting also affects single left-click, single right-click, and double left-click types.
...
![](../Images/bis_click_delay_pgm.png)
