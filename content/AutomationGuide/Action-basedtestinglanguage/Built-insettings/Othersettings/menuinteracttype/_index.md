...
---
# menu interact type {#menu_interact_type .reference}

## Description {#section_qwb_kkc_ggb .section}

Specifies which mouse action \(click or hover\) to take on each middle-level menu item.

## Allowable values {#section_hmq_kmc_ggb .section}
...
## Applicable Systems/Platforms {#section_ss4_rrc_ggb .section}
...
## Applicable Built-in Actions {#section_pvm_vrc_ggb .section}
...
## Example {#section_w2l_xqd_ggb .section}

![](../Images/bis_menu_interact_type_illustration.png)

**Action lines**:

![](../Images/bis_menu_interact_type.png)
