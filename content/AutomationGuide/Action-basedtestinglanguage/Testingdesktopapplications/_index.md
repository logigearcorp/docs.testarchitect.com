...
---
# Testing desktop applications {#concept_testing_desktop_apps .concept}
...
1.  [TestArchitect Register Server](../../TA_Automation/Topics/aut_app_testing_taregserver.html)  
...
2.  [Testing .NET applications](../../TA_Automation/Topics/aut_app_testing_NET_apps.html)  
Information specific to .NET application testing.
3.  [Testing WPF applications](../../TA_Automation/Topics/aut_app_testing_WPF_apps.html)  
Information specific to Windows Presentation Foundation \(WPF\) application testing.
4.  [Testing Java applications](../../TA_Automation/Topics/aut_app_testing_Java_apps.html)  
Information specific to Java application testing.
5.  [Testing Win32 applications](../../TA_Automation/Topics/aut_app_testing_Win32_apps.html)  
Information specific to Win32 application testing.
6.  [Testing Oracle Forms](../../TA_Automation/Topics/aut_app_testing_Oracle_Forms.html)  
...
**Previous topic:**[Testing with databases](../../TA_Automation/Topics/aut_app_testing_Database_apps.html)

**Next topic:**[Testing web and RIA applications](../../TA_Automation/Topics/aut_app_testing_web_RIA.html)
