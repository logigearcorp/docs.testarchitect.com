...
---
# send http request {#bia_send_http_request .reference}
...
## Applicable Built-In Settings {#section_tvt_rhs_1y .section}

The following settings are applicable to this action:[remove double quotes from cells](bis_remove_double_quotes_from_cells.html).

## Example - Case 1: Testing a given Google API to send a message to a recipient {#section_pyg_dsd_1y .section}
...
![](../Images/bia_send_http_request_pgm.png)

**Result**

![](../Images/bia_send_http_request_res.png)

**Effect**

![](../Images/bia_send_http_request_effect.png)

## Example - Case 2: Testing SOAP over HTTP-based web services {#section_tyg_cp3_5z .section}
...
![](../Images/bia_send_http_request_soap_pgm.png)

## Example - Case 3: Retrieving an attachment through returned response body { .section}
...
![](../Images/bia_send_http_request_response_file_pgm.png)
