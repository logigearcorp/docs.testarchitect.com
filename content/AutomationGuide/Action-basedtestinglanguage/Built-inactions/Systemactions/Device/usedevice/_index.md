...
---
# use device {#bia_use_device .reference}
...
## Applicable Systems/Platforms {#section_l1l_pcl_zcb .section}

Use of this action is supported on the following systems/platforms: Mobile operating systems.

## Notes { .section}

-   The name specified in the name argument is established in advance by the [assign device](bia_assign_device.html) action, which assigns a logical name to a mobile device.
...
![](../Images/automation_problem_busy_phone.png)

**Parent topic:**[Device](../../TA_Automation/Topics/bia_device.html)

**Previous topic:**[use cloud device](../../TA_Automation/Topics/bia_use_cloud_device.html)

**Next topic:**[use host machine](../../TA_Automation/Topics/bia_use_host_machine.html)
