...
---
# disconnect cloud device {#bia_disconnect_cloud_device .reference}
...
-   The primary value of this action lies in allowing your test to terminate the connection with the current cloud device, and then switch to another cloud device via calling the next [assign cloud device](bia_assign_cloud_device.html) action.
...
**Previous topic:**[disconnect all cloud devices](../../TA_Automation/Topics/bia_disconnect_all_cloud_devices.html)

**Next topic:**[disconnect device](../../TA_Automation/Topics/bia_disconnect_device.html)
