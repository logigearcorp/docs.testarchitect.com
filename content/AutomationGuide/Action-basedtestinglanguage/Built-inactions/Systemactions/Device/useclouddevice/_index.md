...
---
# use cloud device {#bia_use_cloud_device .reference}
...
-   The session ID specified in the session id argument is retrieved via the [connect cloud device](bia_connect_cloud_device.html) action.
