...
---
# execute sql {#bia_execute_sql_command .reference}
...
## Example - Case 1: Running an SQL command to get a single result { .section}
...
![](../Images/db_CTable.01.png)

**Action Lines**

![](../Images/bia_execute_sql_1_pgm.r02.png)

**Result**

![](../Images/bia_execute_sql_1_res.r01.png)

## Example - Case 2: Running an SQL command to get multiple results { .section}
...
![](../Images/bia_execute_sql_aut.r01.png)

**Action Lines**

![](../Images/bia_execute_sql_2_pgm.r01.png)
...
![](../Images/bia_execute_sql.July_Shipments.png)

1998\_Beverage\_sales.txt

![](../Images/bia_execute_sql.1998_Beverage_sales.png)
