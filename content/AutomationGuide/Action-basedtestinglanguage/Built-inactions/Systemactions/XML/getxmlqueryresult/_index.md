...
---
# get xml query result {#bia_get_xml_query_result .reference}
...
-   Depending upon the XPath query, some of the following notes for the variable argument may apply:
    -   The returned value may contain multiple XML nodes. To extract or check the content of a single line from variable, use the [get text line](bia_get_text_line.html) or [check text line](bia_check_text_line.html) actions. \(See example \#5.\)
...
![](../Images/bia_get_xml_querry_result_1_pgm.png)

**Result**

![](../Images/bia_get_xml_querry_result_1_res.png)
...
![](../Images/bia_get_xml_querry_result_4_pgm.png)

**Result**

![](../Images/bia_get_xml_querry_result_4_res.png)
...
![](../Images/bia_get_xml_querry_result_2_aut.png)
...
![](../Images/bia_get_xml_querry_result_2_pgm.png)

**Result**

![](../Images/bia_get_xml_querry_result_2_res.png)
...
![](../Images/bia_get_xml_querry_result_5_pgm.png)

**Result**

![](../Images/bia_get_xml_querry_result_5_res.png)

## Example - Case 5: Using get text line to extract content { .section}
...
![](../Images/bia_get_xml_querry_result_3_pgm.png)

**Result**

![](../Images/bia_get_xml_querry_result_3_res.png)

## Example - Case 6: Adding a single root element { .section}
...
![](../Images/bia_get_xml_querry_result_6_pgm.png)

**Result**

![](../Images/bia_get_xml_querry_result_6_res.png)

## Example - Case 7: Resolving the problem of namespaces { .section}
...
![](../Images/bia_check_xml_querry_result_7_pgm.png)

**Result**

![](../Images/bia_check_xml_querry_result_7_res.png)
