...
---
# click picture {#bia_click_picture .reference}
...
The following settings are applicable to this action:[case sensitive](bis_case_sensitive.html), [remove double quotes from cells](bis_remove_double_quotes_from_cells.html), [standard ASCII only](bis_standard_ASCII_only.html), [object wait](bis_object_wait.html), [window wait](bis_window_wait.html), [picture algorithm](bis_picture_algorithm.html).

## Example - Case 1: The window and control arguments are specified { .section}

![](../Images/bia_click_picture_aut.png)

**Action Lines**

![](../Images/bia_click_picture_pgm.png)

**Result**

![](../Images/bia_click_picture_res.png)

**Effect**

![](../Images/bia_click_picture_effect.png)

## Example - Case 2: The rect argument is specified { .section}

![](../Images/bia_click_picture_aut_2.png)

**Action Lines**

![](../Images/bia_click_picture_pgm_2.png)

**Result**

![](../Images/bia_click_picture_res_2.png)
...
**Previous topic:**[check picture not exists](../../TA_Automation/Topics/bia_check_picture_not_exists.html)

**Next topic:**[does picture exist](../../TA_Automation/Topics/bia_does_picture_exist.html)
