...
---
# get baseline image count {#bia_baseline_image_count .reference}

## Description { .section}

Retrieve a count of the total number of baseline images that reside in a given picture check.

## Arguments {#section_a2x_t5k_vw .section}
...
## Example - Case 1: Retrieving the total number of a given baseline image {#section_unk_5wk_vw .section}

![](../Images/bia_get_baseline_image_count_aut.png)

**Action Lines**

![](../Images/bia_get_baseline_image_count_pgm.png)

**Result**

![](../Images/bia_get_baseline_image_count_res.png)

## Example - Case 2: Integrating with a third-party image processing tool {#section_x3x_4ft_yw .section}
