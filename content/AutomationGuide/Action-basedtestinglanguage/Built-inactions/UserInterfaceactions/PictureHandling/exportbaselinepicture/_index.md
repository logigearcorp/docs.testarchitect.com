...
---
# export baseline picture {#bia_export_baseline_picture .reference}

## Description { .section}

Save the current baseline image to a file.

## Arguments {#section_nkl_1zk_vw .section}
...
## Example - Case 1: Save the current baseline image to file { .section}

![](../Images/bia_export_baseline_picture_aut.png)

**Action Lines**

![](../Images/bia_export_baseline_picture_pgm.png)

**Result**

![](../Images/bia_export_baseline_picture_res.png)

**Effect**

![](../Images/bia_export_baseline_picture_effect.png)

## Example - Case 2: Integrating with a third-party image processing tool { .section}
...
![](../Images/bia_get_baseline_image_count_aut_2.png)
...
![](../Images/bia_get_baseline_image_count_2_pgm.png)

**Parent topic:**[Picture Handling](../../TA_Automation/Topics/bia_picture_handling.html)

**Previous topic:**[does picture exist](../../TA_Automation/Topics/bia_does_picture_exist.html)

**Next topic:**[get baseline image count](../../TA_Automation/Topics/bia_get_baseline_image_count.html)
