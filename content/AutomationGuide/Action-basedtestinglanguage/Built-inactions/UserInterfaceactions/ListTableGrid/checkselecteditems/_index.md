...
---
# check selected items {#bia_check_selected_items .reference}
...
## Example - Case 1: Use text value to specify list view item { .section}

![](../Images/bia_check_selected_items_aut.png)

**Action Lines**

![](../Images/bia_check_selected_items_pgm.png)

**Result**

![](../Images/bia_check_selected_items_res.png)

## Example - Case 2: Use numerical index value to specify list view item { .section}

![](../Images/bia_check_selected_items_index_aut.png)

**Action Lines**

![](../Images/bia_check_selected_items_index_pgm.png)

**Result**

![](../Images/bia_check_selected_items_index_res.png)

## Example - Case 3: Use text value to specify list box item { .section}

![](../Images/bia_check_selected_items_2_aut.png)

**Action Lines**

![](../Images/bia_check_selected_items_2_pgm.png)

**Result**

![](../Images/bia_check_selected_items_2_res.png)

## Example - Case 4: Use numerical index value to specify list box item { .section}

![](../Images/bia_check_selected_items_2_index_aut.png)

**Action Lines**

![](../Images/bia_check_selected_items_2_index_pgm.png)

**Result**

![](../Images/bia_check_selected_items_2_index_res.png)
...
![](../Images/bia_check_selected_items_ta4vs_pgm.png)

**Result**

![](../Images/bia_check_selected_items_ta4vs_res.png)
