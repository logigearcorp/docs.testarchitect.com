...
---
# click select menu {#bia_click_select_menu .reference}
...
![](../Images/bia_click_select_menu_pgm.png)

**Result**

![](../Images/bia_click_select_menu_res.png)

**Effect**

![](../Images/bia_click_select_menu_aut.png)

## Example { .section}

![](../Images/bia_click_select_menu_ta4vs_aut.png)

**Action Lines**

![](../Images/bia_click_select_menu_ta4vs_pgm.png)
...
![](../Images/bia_click_select_menu_ta4vs_effect.png)

**Parent topic:**[Toolbar, Menu, Scrollbar](../../TA_Automation/Topics/bia_Toolbar_Menu_Scrollbar.html)

**Previous topic:**[check toolbar menu state](../../TA_Automation/Topics/bia_check_toolbar_menu_state.html)

**Next topic:**[click toolbar button](../../TA_Automation/Topics/bia_click_toolbar_button.html)
