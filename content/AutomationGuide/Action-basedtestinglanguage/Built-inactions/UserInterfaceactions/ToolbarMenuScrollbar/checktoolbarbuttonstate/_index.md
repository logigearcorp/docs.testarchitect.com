...
---
# check toolbar button state {#bia_check_toolbar_button_state .reference}
...
![](../Images/bia_check_toolbar_button_state_aut.png)

**Action Lines**

![](../Images/bia_check_toolbar_button_state_pgm.png)

**Result**

![](../Images/bia_check_toolbar_button_state_res.png)

## Example - Case 2: Using a numerical index value for button { .section}

![](../Images/bia_check_toolbar_button_state_index_aut.png)

**Action Lines**

![](../Images/bia_check_toolbar_button_state_index_pgm.png)

**Result**

![](../Images/bia_check_toolbar_button_state_index_res.png)
