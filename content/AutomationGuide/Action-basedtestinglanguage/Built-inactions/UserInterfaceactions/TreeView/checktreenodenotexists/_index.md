...
---
# check tree node not exists {#bia_check_tree_node_not_exists .reference}
...
## Example - Case 1: Using a text value for node path { .section}

![](../Images/bia_check_tree_node_not_exists_aut.png)

**Action Lines**

![](../Images/bia_check_tree_node_not_exists_pgm.png)

**Result**

![](../Images/bia_check_tree_node_not_exists_res.png)

## Example - Case 2: Using a numerical index for node path { .section}

![](../Images/bia_check_tree_node_not_exists_index_aut.png)

**Action Lines**

![](../Images/bia_check_tree_node_not_exists_index_pgm.png)

**Result**

![](../Images/bia_check_tree_node_not_exists_index_res.png)
...
![](../Images/bia_check_tree_node_not_exists_ta4vs_pgm.png)

**Result**

![](../Images/bia_check_tree_node_not_exists_ta4vs_res.png)
