...
---
# check tree node exists {#bia_check_tree_node_exists .reference}
...
![](../Images/bia_check_tree_node_exists_aut.png)

**Action Lines**

![](../Images/bia_check_tree_node_exists_pgm.png)

**Result**

![](../Images/bia_check_tree_node_exists_res.png)

## Example - Case 2: Using a numerical index for node path { .section}

![](../Images/bia_check_tree_node_exists_index_aut.png)

**Action Lines**

![](../Images/bia_check_tree_node_exists_index_pgm.png)

**Result**

![](../Images/bia_check_tree_node_exists_index_res.png)
...
![](../Images/bia_check_tree_node_exists_ta4vs_pgm.png)

**Result**

![](../Images/bia_check_tree_node_exists_ta4vs_res.png)
