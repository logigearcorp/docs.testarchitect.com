...
---
# get tree node status {#bia_get_tree_node_status .reference}
...
![](../Images/bia_get_tree_node_status_aut.png)

**Action Lines**

![](../Images/bia_get_tree_node_status_pgm.png)

**Result**

![](../Images/bia_get_tree_node_status_res.png)

## Example - Case 2: Using a numerical index for node path { .section}

![](../Images/bia_get_tree_node_status_index_aut.png)

**Action Lines**

![](../Images/bia_get_tree_node_status_index_pgm.png)

**Result**

![](../Images/bia_get_tree_node_status_index_res.png)
...
![](../Images/bia_get_tree_node_status_ta4vs_pgm.png)

**Result**

![](../Images/bia_get_tree_node_status_ta4vs_res.png)
