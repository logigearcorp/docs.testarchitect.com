...
---
# get text color {#get_text_color .reference}
...
![](../Images/bia_get_text_color_aut.png)

**Action Lines**

![](../Images/bia_get_text_color_pgm.png)

**Result**

![](../Images/bia_get_text_color_res.png)

**Parent topic:**[Optical Character Recognition](../../TA_Automation/Topics/bia_OCR.html)

**Previous topic:**[get text background color](../../TA_Automation/Topics/bia_get_text_background_color.html)

**Next topic:**[get text content](../../TA_Automation/Topics/bia_get_text_content.html)
