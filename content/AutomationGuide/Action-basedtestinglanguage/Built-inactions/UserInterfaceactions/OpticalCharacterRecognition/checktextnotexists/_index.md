...
---
# check text not exists {#bia_check_text_not_exists .reference}
...
![](../Images/bia_check_text_not_exists_aut.png)

**Action Lines**

![](../Images/bia_check_text_not_exists_pgm.png)

**Result**

![](../Images/bia_check_text_not_exists_res.png)

## Example - Case 2: With rect argument specified { .section}

![](../Images/bia_check_text_not_exists_aut_2.png)

**Action Lines**

![](../Images/bia_check_text_not_exists_pgm_2.png)

**Result**

![](../Images/bia_check_text_not_exists_res_2.png)

## Example - Case 3: With index argument specified { .section}

![](../Images/bia_check_text_not_exists_aut_3.png)

**Action Lines**

![](../Images/bia_check_text_not_exists_pgm_3.png)

**Result**

![](../Images/bia_check_text_not_exists_res_3.png)

## Example - Case 4: With text color argument specified { .section}

![](../Images/bia_check_text_not_exists_aut_4.png)

**Action Lines**

![](../Images/bia_check_text_not_exists_pgm_4.png)

**Result**

![](../Images/bia_check_text_not_exists_res_4.png)

**Parent topic:**[Optical Character Recognition](../../TA_Automation/Topics/bia_OCR.html)

**Previous topic:**[check text exists](../../TA_Automation/Topics/bia_check_text_exists.html)

**Next topic:**[clear ocr setting](../../TA_Automation/Topics/bia_clear_ocr_setting.html)
