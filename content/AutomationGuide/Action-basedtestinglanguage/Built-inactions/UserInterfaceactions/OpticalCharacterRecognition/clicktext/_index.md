...
---
# click text {#bia_click_text .reference}
...
:   ![](../../reuse/../TA_Automation/Images/ocr_area_specs_01.png)
...
:   This value is obtained from the [OCR Detector Tool](../../reuse/../TA_Help/Topics/ug_OCR_detector_tool_retrieving_color_code.md#note_e3p_3yg_g4) dialog box.

## Valid contexts { .section}

This action may be used within the following project items:test modules and user-defined actions.

## Notes {#section_lgn_3ht_lk .section}
...
## Example - Case 1: With window and control arguments specified { .section}

![](../Images/bia_click_text_aut.png)

**Action Lines**

![](../Images/bia_click_text_pgm.png)

**Result**

![](../Images/bia_click_text_res.png)

**Effect**

![](../Images/bia_click_text_effect.png)

## Example - Case 2: With rect argument specified { .section}

![](../Images/bia_click_text_aut_2.png)

**Action Lines**

![](../Images/bia_click_text_pgm_2.png)

**Result**

![](../Images/bia_click_text_res_2.png)

**Effect**

![](../Images/bia_click_text_effect.png)

## Example - Case 3: With text color argument specified { .section}

![](../Images/bia_click_text_aut_3.png)

**Action Lines**

![](../Images/bia_click_text_pgm_3.png)

**Result**

![](../Images/bia_click_text_res_3.png)

**Parent topic:**[Optical Character Recognition](../../TA_Automation/Topics/bia_OCR.html)

**Previous topic:**[clear ocr setting](../../TA_Automation/Topics/bia_clear_ocr_setting.html)

**Next topic:**[does text exist](../../TA_Automation/Topics/bia_does_text_exist.html)
