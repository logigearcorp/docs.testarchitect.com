...
---
# on failure action {#bia_on_failure_action .reference}
...
## Example - Case 1: Failure handler with no arguments { .section}

**Action Lines**

![](../Images/bia_on_failure_action_pgm.png)

**Result**

![](../Images/bia_on_failure_action_res.png)

## Example - Case 2: Failure handler with arguments { .section}

**Action Lines**

![](../Images/bia_on_failure_action_2_pgm.png)

**Result**

![](../Images/bia_on_failure_action_2_res.png)
