...
---
# run test {#bia_run_test .reference}
...
## Example - Case 1: Drag and drop operations { .section}

![](../Images/bia_run_aut_1.png)

## Example - Case 2: run test action { .section}

Alternatively, you can enter the run test built-in action directly into the test editor.

**Action Lines**

![](../Images/bia_run_pgm_2.png)
