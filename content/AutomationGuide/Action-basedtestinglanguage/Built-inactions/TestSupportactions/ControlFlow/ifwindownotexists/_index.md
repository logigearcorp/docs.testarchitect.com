...
---
# if window not exists {#bia_if_window_not_exists .reference}
...
-   If the specified window is not found, the succeeding block of action lines up until the first occurrence of an [else](bia_else.html), [else if](bia_else_if.html), or [end if](bia_end_if.html), is executed. Otherwise, that block is skipped.
-   The if window not exists action, in effect, combines the [does window exist](bia_does_window_exist.html) and [if](bia_if.html) built-in actions, with the if condition properly constructed.
...
![](../Images/bia_if_window_not_exists_pgm.png)

**Result**

![](../Images/bia_if_window_not_exists_res.png)

## Example { .section}

**Action Lines**

![](../Images/bia_if_window_not_exists_ta4vs_pgm.png)

**Result**

![](../Images/bia_if_window_not_exists_ta4vs_res.png)
