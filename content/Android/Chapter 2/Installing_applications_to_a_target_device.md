---
title: "Installing the re-signed Android application onto a target device {#Installinganapplicationtoatargetdevice .task}"
---
...
1.  Open the [Manage Application Under Test](Installing_applications_resigning.md) dialog box
...
4.  Click **Install**.
    ...
    **Note:**
    ...
    -   If you encounter issues while installing, refer to [Troubleshooting custom signatures](../../TA_FAQ/Topics/faq.tshoot.Android_custom_signature.md).
...
**Previous topic:**[Re-signing the Android application](../../Android/Topics/Installing_applications_resigning.md)
