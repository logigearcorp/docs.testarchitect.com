---
title: "Devices panel {#Devices_area .concept}"
---

# Devices panel {#Devices_area .concept}
...
![](../Images/AIT_devices_panel.png)

In the Devices panel, there are five possible icons representing detected device types and their current states:

|![](../Images/android_4.png)|Unavailable physical device on USB port|
|![](../Images/android_5.png)|Available physical device on USB port|
|![](../Images/android_6.png)|Available physical device on Wi-Fi connection|
|![](../Images/android_7.png)|Unavailable emulator|
|![](../Images/android_8.png)|Available emulator|
