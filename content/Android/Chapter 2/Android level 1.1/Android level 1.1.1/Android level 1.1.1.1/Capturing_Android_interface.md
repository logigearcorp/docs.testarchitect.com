---
title: "Capturing an Android interface with the Interface Viewer {#taskefr545_zn .task}"
---
...
-   You are familiar with the Interface Viewer and the concepts involved in creating an interface. \([Learn more](../../TA_Help/Topics/Interface_def_Viewer.md).\)
-   A connection between your Android device and the host machine has been established. \([Lear more](Setting_up_installation_target_devices.md).
-   The re-signed application is active on your Android device. \([Learn more](Launching_an_AUT.md).\)

Do the following to capture interface entities/elements of the re-signed application running on your Android device:

1.  Launch the [Interface Viewer](../../TA_Help/Topics/Interface_def_Viewer_Starting.md).
...
-   To allow Auto Highlight to work properly, ensure that [application notification](../../TA_FAQ/Topics/faq.tshoot.Android_viewer_not_working.md) of TestArchitect Automation Agent is enabled..
...
**Previous topic:**[Setting up the test environment](../../Android/Topics/Setting_up_the_test_enviroment.md)

**Next topic:**[Starting Android automated tests](../../Android/Topics/Android_execution.md)
