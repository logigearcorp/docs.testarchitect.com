---
title: "Starting an Android application from the command line tool {#taskopqdq2_5l .task}"
---

# Starting an Android application from the command line tool {#task_opq_dq2_5l .task}
...
2.  Type ast.exe start "com.logigear" -s "2c4401c15d52" to start the Car Rental application installed on the targeted Android device whose unique ID is 2c4401c15d52.
    ...
    Review [Start command](Android_command_line_tool_start.md#p_n3t_vr2_5l) to understand the Start command's syntax.
...
**Parent topic:**[Start command of the Android command line tool](../../Android/Topics/Android_command_line_tool_start.md)
