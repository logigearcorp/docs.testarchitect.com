---
title: "Uninstalling an Android application from the command line tool {#taskf3ggt2_5l .task}"
---

# Uninstalling an Android application from the command line tool {#task_f3g_gt2_5l .task}
...
2.  Type ast.exe uninstall "com.logigear" -s "2c4401c15d52" -k to uninstall the Car Rental application on the targeted Android device whose unique ID is 2c4401c15d52, but to keep the data and cache directories after uninstalling the package.
    ...
    Review [Uninstall command](Android_command_line_tool_uninstall.md#p_sxr_4t2_5l) to understand the Uninstall command's syntax.
...
**Parent topic:**[Uninstall command of the Android command line tool](../../Android/Topics/Android_command_line_tool_uninstall.md)
