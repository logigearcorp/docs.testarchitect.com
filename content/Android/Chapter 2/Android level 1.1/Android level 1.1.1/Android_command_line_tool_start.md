---
title: "Start command of the Android command line tool {#referencekxnf5d_5l .reference}"
---
...
-   **[Starting an Android application from the command line tool](../../Android/Topics/Android_command_line_tool_start_step.md)**  
...
**Previous topic:**[Installing the Android command line tool](../../Android/Topics/Android_command_line_tool_install.md)

**Next topic:**[Uninstall command of the Android command line tool](../../Android/Topics/Android_command_line_tool_uninstall.md)

**Related information**  


[Launching an Android AUT](../../Android/Topics/Launching_an_AUT.md)
