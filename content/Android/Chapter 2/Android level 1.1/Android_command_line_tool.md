---
title: "Android command line tool {#Androidtoolcommand_line .concept}"
---

# Android command line tool {#Android_tool_command_line .concept}
...
1.  [Installing the Android command line tool](../../Android/Topics/Android_command_line_tool_install.md)  
The Install command is used to re-sign an Android application, and then to install it.
2.  [Start command of the Android command line tool](../../Android/Topics/Android_command_line_tool_start.md)  
The Start command is used to launch an Android application from an Android device.
3.  [Uninstall command of the Android command line tool](../../Android/Topics/Android_command_line_tool_uninstall.md)  
The Uninstall command is used to uninstall an application from an Android device.
4.  [Help command of the Android command line tool](../../Android/Topics/Android_command_line_tool_help.md)  
...
**Previous topic:**[Starting Android automated tests](../../Android/Topics/Android_execution.md)

**Next topic:**[Configuring customized signatures](../../Android/Topics/Android_configuring_customized_certificate.md)
