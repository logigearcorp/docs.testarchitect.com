---
title: "Installing the Android command line tool {#referencezwtrtd_5l .reference}"
---

# Installing the Android command line tool {#reference_zwt_rtd_5l .reference}
...
-   **[Installing an application with the Android command line tool](../../Android/Topics/Android_command_line_tool_install_step.md)**  
This example demonstrates the steps involved in running the Android command line tool with the Install command.

**Parent topic:**[Android command line tool](../../Android/Topics/Android_command_line_tool.md)

**Next topic:**[Start command of the Android command line tool](../../Android/Topics/Android_command_line_tool_start.md)

**Related information**  


[Installing a testable Android application](../../Android/Topics/Installing_applications.md)

[Re-signing the Android application](../../Android/Topics/Installing_applications_resigning.md)

[Installing the re-signed Android application onto a target device](../../Android/Topics/Installing_applications_to_a_target_device.md)

[execute command](../../TA_Automation/Topics/bia_execute_command.md)
