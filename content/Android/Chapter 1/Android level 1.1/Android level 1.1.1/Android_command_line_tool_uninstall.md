---
title: "Uninstall command of the Android command line tool {#referencekph15d_5l .reference}"
---

# Uninstall command of the Android command line tool {#reference_kph_15d_5l .reference}
...
-   **[Uninstalling an Android application from the command line tool](../../Android/Topics/Android_command_line_tool_uninstall_step.md)**  
...
**Previous topic:**[Start command of the Android command line tool](../../Android/Topics/Android_command_line_tool_start.md)

**Next topic:**[Help command of the Android command line tool](../../Android/Topics/Android_command_line_tool_help.md)
