---
title: "Re-signing the Android application {#Installingapplicationsresigning .task}"
---
...
3.  To re-sign a new .apk application file, click the **Re-sign more** button.
    ...
    **Tip:** By default, TestArchitect re-signs an Android application with a LogiGear signature. You may alternatively select to re-sign the application with your self-signed signatures \(refer to [Configuring customized signatures](Android_configuring_customized_certificate.md) for details\). If you encounter issues while re-signing, refer to [Troubleshooting custom signatures](../../TA_FAQ/Topics/faq.tshoot.Android_custom_signature.md).
...
**Parent topic:**[Installing a testable Android application](../../Android/Topics/Installing_applications.md)

**Next topic:**[Installing the re-signed Android application onto a target device](../../Android/Topics/Installing_applications_to_a_target_device.md)
