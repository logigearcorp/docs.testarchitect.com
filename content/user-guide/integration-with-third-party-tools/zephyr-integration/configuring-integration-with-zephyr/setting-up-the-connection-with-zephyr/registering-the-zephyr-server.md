...
description: "Registering the Zephyr server is the first action you need to perform to prepare a TestArchitect-Zephyr integrated environment."
weight: 1
aliases: 
    - /TA_Help/Topics/ug_Zephyr_registering_server.html
keywords: "integration, Zephyr, registering server, registering server"
---
...
Before registering the Zephyr server with TestArchitect, open TestArchitect Client and ensure that you have [administrator group](/administration-guide/users-and-passwords/user-administration/) login privileges for the TestArchitect repository you will be using. Also make sure you have the following Zephyr server information:
...
6.  Click **Apply**.
    ...
    -   If you have specified HTTPS and the Zephyr server's identity has not been verified by a trusted third-party, or the SSL certificate installed on your test machine has expired, a Verify Certificate security alert is displayed. To install the SSL certificate, click the **Accept** button.
        ...
        ![](/images/TA_Help/Images/Zephyr_verify_cert_dlg.02.png)
