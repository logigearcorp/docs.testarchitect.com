...
-   Prior to [running automated tests from Zephyr](/user-guide/integration-with-third-party-tools/zephyr-integration/features-of-testarchitect-zephyr-integration/executing-tests-from-zephyr), it is required that you repeat step [5](/user-guide/integration-with-third-party-tools/zephyr-integration/configuring-integration-with-zephyr/setting-up-the-connection-with-zephyr/configuring-zbots-and-installing-zips#step_start_zbot) to start the ZBot service manually.
