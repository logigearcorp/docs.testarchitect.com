...
description: "User-defined fields in TestArchitect are automatically mapped to Zephyr custom fields when the names and data types match."
weight: 7
aliases: 
    - /TA_Help/Topics/ug_Zephyr_creating_custom_fields.html
keywords: "integration, Zephyr, custom fields"
---
...
1.  Create a user-defined field in TestArchitect.
    ...
    -   Value Type: Field data types must match between TestArchitect and Zephyr \(See the [TestArchitect and Zephyr Data Types table](/user-guide/integration-with-third-party-tools/zephyr-integration/features-of-testarchitect-zephyr-integration/rules-for-mapping-custom-fields-between-testarchitect-and-zephyr) for details\).
...
2.  Create a custom test case field in Zephyr that matches the user-defined field in TestArchitect. \([Learn more](https://zephyrdocs.atlassian.net/wiki/spaces/ZE61/pages/263554654/Customize+Testcase+Fields).\)
    ...
    ![](/images/TA_Help/Images/Zephyr_custom_fields_6.1.png)

    ![](/images/TA_Help/Images/Zephyr_match_custom_field_6.1.png)
