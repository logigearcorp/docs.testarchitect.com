...
4.  In the list view of test cases, select the check boxes corresponding to the desired test cases. Next, click the ![](/images//Images/Zephyr_e_btn_6.1.png) button next to **Execution**.

    ![](/images//Images/Zephyr_execution_6.1.png)
...
5.  In the Execute Automation Scripts dialog box, from the **Select ZBot** dropdown list select the machine whose ZBot will run the automation scripts. Next, click the **Run** button.
    ...
    ![](/images//Images/Zephyr_execute_automation_scripts_6.1.png)
    ...
    ![](/images//Images/TA_Execution_dlg.png)
...
6.  In the dialog box, enter the requested information as described below:
    ...
    2.  **General** tab:
        ...
        ![](/images//Images/Scheduler_Zephyr_general.png)

        1.  Automation Tools panel:

            ![](/images//Images/TFS_TAScheduler_Automation_Tools_panel.png)
            ...
            ![](/images//Images/TFS_Automation_tools_dlg.png)
        ...
        2.  Controllers/Devices panel:
            ...
            ![](/images//Images/TA_Execution_dlg_controllers_devices_panel.png)

            -   Select Controllers/Devices: Click this button to designate which controller and device the test will execute on.

                ![](/images//Images/TFS_Select_controllers_devices_dlg.png)
    ...
    3.  **Advanced** tab:
        ...
        5.  **Automatically add result\(s\) to repository**: Select this check box if you want to add test results automatically to the repository once the test concludes.
            ...
            ![](/images//Images/TA_Execution_dlg_add_results_repo_panel.png)
