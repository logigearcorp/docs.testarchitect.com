...
1.  [Check out](/user-guide/projects-and-project-items/project-items/revision-control/check-out) the target TestArchitect test folder/test module into which you want to import the Zephyr folder/test case.
