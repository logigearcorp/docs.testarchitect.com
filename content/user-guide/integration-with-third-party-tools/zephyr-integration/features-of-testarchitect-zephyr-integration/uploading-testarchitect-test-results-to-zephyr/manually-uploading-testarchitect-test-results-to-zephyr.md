...
description: "TestArchitect test results from projects or test cases which are mapped to Zephyr can be uploaded to Zephyr by manual means as well as automatic."
weight: 2
aliases: 
    - /TA_Help/Topics/ug_Zephyr_manual_uploading_results.html
keywords: "integration, Zephyr, manually uploading test results"
---
...
1.  In the TestArchitect explorer tree or [a result list view](/user-guide/projects-and-project-items/project-items/list-view/result-list-view/), right-click the preferred test result or test result folder, and then select **External Tool** \> **Zephyr** \> **Upload to Zephyr**.

2.  In the Select Test Case To Upload dialog box,

    ![](/images/TA_Help/Images/Zephyr_manual_upload_results.png)
    ...
    ![](/images/TA_Help/Images/Zephyr_successful_auto_upload_results.png)
...
To view the uploaded results on Zephyr, see the [next topic](/user-guide/integration-with-third-party-tools/zephyr-integration/features-of-testarchitect-zephyr-integration/uploading-testarchitect-test-results-to-zephyr/viewing-uploaded-test-results-on-zephyr).
