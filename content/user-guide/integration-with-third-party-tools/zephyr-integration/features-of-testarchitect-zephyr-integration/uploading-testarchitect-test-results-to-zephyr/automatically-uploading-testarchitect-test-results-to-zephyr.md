...
description: "You can configure TestArchitect to automatically upload test results to Zephyr upon conclusion of a test run."
weight: 1
aliases: 
    - /TA_Help/Topics/ug_Zephyr_auto_uploading_results.html
keywords: "integration, Zephyr, automatically uploading test results"
---
...
2.  Switch to the **Advanced** tab and then select the select the **Upload result to Zephyr** checkbox.
    ...
    ![](/images/TA_Help/Images/Zephyr_auto_upload_results_settings.png)

3.  Under the **Upload result to Zephyr** checkbox,

    1.  Click the Browse ![](/images/TA_Help/Images/btn.browse-ellipsis.02.png) button.
    ...
    2.  In the Select location in Zephyr dialog box, select the destination in Zephyr where you want to upload the TestArchitect test result.
        ...
        ![](/images/TA_Help/Images/Zephyr_auto_upload_results_destination.png)
...
To view the uploaded results on Zephyr, see [Viewing uploaded test results on Zephyr](/user-guide/integration-with-third-party-tools/zephyr-integration/features-of-testarchitect-zephyr-integration/uploading-testarchitect-test-results-to-zephyr/viewing-uploaded-test-results-on-zephyr).
