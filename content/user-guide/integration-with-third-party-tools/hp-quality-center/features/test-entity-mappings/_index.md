...
|**Name**|![](/images//Images/TA-QC.flow.upload.png)
...
|**Editor** tab: line\(s\) in OBJECTIVES section|![](/images//Images/TA-QC.flow.import.png)
...
|**ID**, **Title**|![](/images//Images/TA-QC.flow.upload.png)

**ID** + ', ' + **Title**\*|**Test Name**|test|\*Conditioned on [`title in comment=no`](Integration_QC_connecting_repo_to_QC_server_step_1.html#li.title_in_comment) \(default\)|
|**Title**|![](/images//Images/TA-QC.flow.upload.png)

'Title: ' + **Title**|**Comments**|test|Conditioned on [`title in comment=yes`](Integration_QC_connecting_repo_to_QC_server_step_1.html#li.title_in_comment)|
