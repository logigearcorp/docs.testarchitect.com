...
|**Source**|The TFS bug ID associated with the TA bug. **Note:**-   If this is an unregistered bug, this field is empty.-   You may change the **Source** value to drop the current link and association this bug with another TFS bug.-   You can also clear the **Source** content to decouple this bug from its associated TFS bug, rendering this an unregistered bug.|
...
|**Last refresh status**|The status of the most recent refresh via clicking the **Refresh** button .The 4 possible returned values are:-   Empty: This bug is unregistered.-   Updated: This registered bug was updated successfully.-   Failed: This registered bug was not updated successfully.-   Nonexistent on TFS: The corresponding TFS bug was deleted.|
