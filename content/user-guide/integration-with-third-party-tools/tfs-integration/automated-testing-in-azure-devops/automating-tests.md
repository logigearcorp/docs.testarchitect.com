...
## {{< expand >}} Preconditioning {{< permerlink >}} {#Azure_DevOps_automating_tests__section_fcs_mcx_pfb} 
...
## {{< expand >}} Creating a build definition and queuing a build {{< permerlink >}} {#Azure_DevOps_automating_tests__section_d4y_bdx_pfb} 
...
## {{< expand >}} Creating a release definition {{< permerlink >}} {#Azure_DevOps_automating_tests__section_jc3_5wd_qfb} 
...
## {{< expand >}} Running automated tests {{< permerlink >}} {#Azure_DevOps_automating_tests__section_jzp_312_qfb} 
