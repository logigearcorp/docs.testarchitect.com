...
1.  [Working with Eclipse](/user-guide/integration-with-third-party-tools/working-with-eclipse/)  
Integration between TestArchitect™ and the Eclipse™ enhances testing and the debugging of user-scripted actions in Eclipse.
2.  [HP Quality Center](/user-guide/integration-with-third-party-tools/hp-quality-center/)  
...
3.  [Team Foundation Server integration](/user-guide/integration-with-third-party-tools/tfs-integration/)  
...
4.  [Continuous integration \(CI\) tools](/user-guide/integration-with-third-party-tools/continuous-integration-ci-tools/)  
...
5.  [JIRA integration](/user-guide/integration-with-third-party-tools/jira-integration/)  
...
6.  [Zephyr integration](/user-guide/integration-with-third-party-tools/zephyr-integration/)  
...
7.  [LDAP overview](/user-guide/integration-with-third-party-tools/ldap-overview/)  
