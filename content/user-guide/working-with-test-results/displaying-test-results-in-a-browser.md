...
1.  In TestArchitect, retrieve and copy the web link address of the TestArchitect [repository test results](/user-guide/working-with-test-results/adding-test-results-to-the-repository/) from the **Web Link** field on the **Information** tab.
