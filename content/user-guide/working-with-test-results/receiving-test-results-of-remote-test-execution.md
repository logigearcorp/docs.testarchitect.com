...
To retrieve test results returned from the [remote machine](/user-guide/test-execution/methods-of-test-execution/remote-test-execution/asynchronous-remote-execution) the next time you start TestArchitect Client, do the following:
