...
-   **Option 2:**
    ...
    2.  Click the **Add results to repository** ![](/images//Images/add_results_to_repo_icon.png) icon on the main panel.

        ![](/images//Images/add_results_to_repo_icon_main_panel.png)
