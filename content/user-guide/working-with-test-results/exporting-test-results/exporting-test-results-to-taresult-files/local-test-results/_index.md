...
-   **Option \#1**: Manually exporting test results to .TARESULT.
    ...
    2.  Invoke the Export Result\(s\) To File dialog box by doing one of the following:
        ...
        -   Alternatively, double-click the selection, and then click the **Save to file** ![](/images//Images/Save_to_file_HTML_icon.png) icon on the main panel's toolbar.
        The Export Result\(s\) To File dialog appears.

        ![](/images//Images/Export_Results_To_File_local_result_dlg.png)
...
-   **Option \#2**: Directing TestArchitect to automatically export test results to .TARESULT upon test completion.
    ...
    4.  Select the **Export Result\(s\) to TARESULT** check box.
        ...
        ![](/images//Images/Export_TARESULT_execute_dlg.png)

    5.  Click ![](/images//Images/btn.browse-ellipsis.01.png) to choose a location to which to save the .TARESULT file.
