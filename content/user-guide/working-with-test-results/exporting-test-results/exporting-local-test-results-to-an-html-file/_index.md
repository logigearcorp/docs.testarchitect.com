...
-   **Option \#1**: Manually exporting test results to HTML.
    ...
    2.  Invoke the Save Result\(s\) To File dialog box by doing one of the following:
        ...
        -   Double-click the selection, and then click the **Save to file** ![](/images//Images/Save_to_file_HTML_icon.png) icon on the main panel's toolbar.
    3.  In the Save Result\(s\) To File dialog box, choose a location to which to save the HTML file.

        ![](/images//Images/Save_results_to_file_dlg.png)
...
-   **Option \#2**: Directing TestArchitect to automatically export test results to HTML upon test completion.
    ...
    5.  Click ![](/images//Images/btn.browse-ellipsis.01.png) to choose a location to which to save the HTML file.

        ![](/images//Images/export_repo_result_HTML_screenshot_automatic.png)
