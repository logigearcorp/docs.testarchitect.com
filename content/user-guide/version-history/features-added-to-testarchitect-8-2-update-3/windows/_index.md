...
-   **Team Foundation Server-Microsoft Test Manager integration improvement**
    ...
    -   **You can now configure TestArchitect to select, based on run status \(Passed, Failed, etc.\), which HTML-based test results are sent to MTM** as an attachment during an [automatic](/TA_Help/Topics/ug_MTM_upload_result_automatic.html#step.Upload_attachement_MTM) or [manual](/TA_Help/Topics/ug_MTM_upload_result_manual.html#step.Conditional_upload_results) upload.
...
-   **Mobile testing**
    -   **Support for mobile apps testing on [Android 5.x](/Android/Topics/Android_Automation_begin.html#table.Android_versions) and [iOS 9.x](/iOS/Topics/iOS_automation_def.html#row.iOS_version)**
