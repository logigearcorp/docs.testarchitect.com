...
-   **[Generating batch file to run on separate terminals](/TA_Help/Topics/Additional_features_preferences.html#li.xterm)**: Activating this option forces your batch files to run on multiple terminals in a parallel manner.
