...
-   Option 2: Unlocking container classes from the **Settings** tab on the Interface Viewer.
    ...
    2.  Launch the [Interface Viewer](/user-guide/interface-definitions/the-interface-viewer/starting-the-interface-viewer).
