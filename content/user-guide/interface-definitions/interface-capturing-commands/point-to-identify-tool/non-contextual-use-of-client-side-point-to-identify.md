...
4.  After making any chosen changes, click **Save**.
    ...
    {{<note>}} If you want to save your interface element to an existing interface entity, proceed to step [5](/user-guide/interface-definitions/interface-capturing-commands/point-to-identify-tool/non-contextual-use-of-client-side-point-to-identify#step.select_int_ent), or proceed to step [8](/user-guide/interface-definitions/interface-capturing-commands/point-to-identify-tool/non-contextual-use-of-client-side-point-to-identify#step.create_int_ent) to create a new interface entity to house this new element.
