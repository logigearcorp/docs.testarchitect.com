...
description: "A step-by-step guide to mapping unknown controls to a known class (built-in TA class, or user-defined TA class)."
weight: 1
aliases: 
    - /TA_Help/Topics/Mapping_unknown_controls_to_known_class.html
keywords: "interface viewer, mapping unknown controls, known class, viewer, mapping, unknown controls, known class, mapping known class"
---
...
3.  In the UI explorer tree panel, navigate to your choice of an unknown class \(as indicated by a ![](/images/TA_Help/Images/ug_interface_definition41.png) icon\), right-click a control node under it, and then click **Map to Known Class**.

    The Map to Known Class dialog box is displayed.

    ![](/images/TA_Help/Images/Map_to_known_class_dialog.png)
...
The unknown control\(s\) are mapped to the existing built-in or user-defined TA class, with the mapping recorded in the [$ Class Maps](/user-guide/interface-definitions/class-mapping/class-maps-entity) entity.
