...
3.  In the UI explorer tree panel, navigate to your choice of an unknown class \(as indicated by a ![](/images//Images/ug_interface_definition41.png) icon\), right-click a control node under it, and then click **Map to New Class**.
