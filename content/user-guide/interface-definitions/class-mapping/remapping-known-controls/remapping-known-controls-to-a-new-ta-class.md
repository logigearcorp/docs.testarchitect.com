...
The known controls are remapped to the new, user-defined TA class, with the mapping recorded in the [$ Class Maps](/user-guide/interface-definitions/class-mapping/class-maps-entity) entity.
