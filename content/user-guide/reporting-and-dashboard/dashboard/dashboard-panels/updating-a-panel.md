...
2.  **Optional:** If the logged-in user is the owner of the panel being updated, a Save Filters dialog box appears asking if you want to save the changed filters. Select an appropriate choice \(explained below\) and click **OK**.
