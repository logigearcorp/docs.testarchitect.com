...
description: "Use an indicator panel to show numerical values of statistic fields in a table format. Values matching user definable range can be highlighted with different colors to indicate the level of importance."
weight: 1
aliases: 
    - /TA_Help/Topics/Dashboard_create_new_indicator_panel.html
keywords: "Dashboard, creating indicator panel, panel, indicator, creating new panel"
---
...
1.  [Launch an instance of the Dashboard](/user-guide/reporting-and-dashboard/dashboard/starting-the-dashboard/) and log in to the session as a user with [permission](/user-guide/reporting-and-dashboard/dashboard/dashboard-permissions) to create a panel.
...
3.  On the Add New Panel dialog box, select the **Indicator** radio button as the panel **Type**, and then enter the information as requested and click **OK**.
    ...
    ![](/images/TA_Help/Images/Dashboard_add_new_indicator_panel_settings_tab.png)
    ...
    **Indicator Settings**:
    ...
    -   ![](/images/TA_Help/Images/Dashboard_add_new_indicator_panel_plus_icon.png): adds one more **From** and **Color** control pair.
    -   ![](/images/TA_Help/Images/Dashboard_add_new_indicator_panel_delete_icon.png): removes a **From** and **Color** control pair.
