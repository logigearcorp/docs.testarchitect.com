...
description: "In this activity, you will create a heat map, which is a matrix in which the color, or shade, of each cell is used to represent a certain quantitative and/or qualitative value."
weight: 7
weight: 7
aliases: 
    - /TA_Tutorials/Topics/tutDashboard_heat_map.html
keywords: "Dashboard, heat map, tutorial, tutorials, heat map"
---
...
1.  [Create a new data profile](/testarchitect-tutorial/part-3-extending-testarchitect/lesson-9-creating-dashboard-panelsdashboard-tutorials/creating-a-data-profiletutorial-creating-a-data-profile) with the folowing settings:
...
2.  Create a new Dashboard panel with the following settings:
    ...
    2.  In the Add New Panel dialog, enter the values as specified above, and click **OK**.
        ...
        ![](/images/TA_Tutorials/Images/tut.Dashboard.Add_New_Panel.Car_Rental.Heat_map.01.png)
