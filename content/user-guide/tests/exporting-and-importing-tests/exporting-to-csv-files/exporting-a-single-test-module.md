...
1.  Invoke the Export Test Module dialog box by doing one of the following:
    ...
    -   Open the [test module list view](/user-guide/projects-and-project-items/project-items/list-view/test-module-list-view/). From the list view, right-click a test module, and then select **Export** \> **to CSV file**.
