...
1.  Invoke the Export Test Case dialog box by doing one of the following:
    ...
    -   Open the [test case list view](/user-guide/projects-and-project-items/project-items/list-view/test-case-list-view/). From the list view, right-click a test case, and then select **Export to CSV file**.
