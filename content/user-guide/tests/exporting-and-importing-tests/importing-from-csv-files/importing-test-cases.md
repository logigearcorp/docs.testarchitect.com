...
-   The test module must be [checked out](/user-guide/projects-and-project-items/project-items/revision-control/check-out) prior to importing a test case to it.
...
1.  Invoke the Select dialog box by doing one of the following:
    ...
    -   Open the [test module list view](/user-guide/projects-and-project-items/project-items/list-view/test-module-list-view/). From the list view, right-click a test module, and then select **Import**.
