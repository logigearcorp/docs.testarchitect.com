...
1.  Invoke the New Test Module dialog box by doing one of the following:
    ...
    -   In the TestArchitect explorer tree, select any item within the current project, and then click the **Create new test module** ![](/images/TA_Automation/Images/btn.TAC_toolbar.CreateTestModule.png) button in the toolbar.
