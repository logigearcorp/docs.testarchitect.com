...
## Using the TAController command {{< permerlink >}} {#Controller_starting_from_CLI__section_uk4_44l_ggb} 
...
## Using the TACTRL command {{< permerlink >}} {#Controller_starting_from_CLI__section_ekx_jrl_ggb} 
