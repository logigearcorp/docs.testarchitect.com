...
-   [**Opening**](Favorite_items_opening.html#step_rr3_w1h_4l): Conveniently open multiple favorites from the list view.
-   [**Removing**](Favorite_items_removing.html): Remove multiple favorites within the list view.
-   [**Adding all open tabs to favorites**](Favorite_items_adding.html#step_mfb_gbh_4l): Bookmark all open items at once.
