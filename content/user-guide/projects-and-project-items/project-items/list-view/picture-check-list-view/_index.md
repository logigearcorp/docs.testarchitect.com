...
You can save a captured screen image as a new baseline for an existing image. \(For details, see [Saving new baseline image](Additional_features_image_capturing_add_new_baseline.html) and [Baseline Picture](Projects_and_tests_picture_check.html#section_mwp_1d1_1l).\)
