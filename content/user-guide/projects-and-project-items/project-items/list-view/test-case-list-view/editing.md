...
title: "Editing"
linktitle: "Editing"
description: "You can directly edit the value of a field in a test case list view."
weight: 2
aliases: 
    - /TA_Help/Topics/Listview_test_case_editing.html
keywords: "editing, list view, test cases"
---

You can directly edit the value of a field in a test case list view.

[Editable fields](/user-guide/projects-and-project-items/project-items/list-view/editable-fields) fields of test cases listed in test case list views can be edited directly.
...
3.  Double-click an [editable field](/user-guide/projects-and-project-items/project-items/list-view/editable-fields) of the selected test case \(for example, the Name field\), or press F2 on the keyboard.
