...
The contents of fields belonging to test cases can be replaced if they are [editable fields](/user-guide/projects-and-project-items/project-items/list-view/editable-fields).
