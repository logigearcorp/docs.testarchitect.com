...
On the TestArchitect explorer tree, when you double-click the **Picture Checks** node, and then select the **Pictures** tab. TestArchitect displays in the main panel a list view of the picture checks for the project. \([Learn more](/user-guide/projects-and-project-items/project-items/picture-checks/).\)
