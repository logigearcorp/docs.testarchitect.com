...
The baseline result for a test related to a selected test result can be displayed by selecting **Go to baseline result** from the context menu. \([Learn more](Test_result_baselining.html#section_kyn_rmm_bl).\)
