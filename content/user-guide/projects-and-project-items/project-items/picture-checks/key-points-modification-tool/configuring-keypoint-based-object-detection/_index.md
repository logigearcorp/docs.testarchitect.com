...
2.  In the **Baseline** tab, click the **Browse** ![](/images//Images/btn.browse-ellipsis.01.png) button next to the **Key Point** field.

    ![](/images//Images/Baseline_tab.png)
    ...
    ![](/images//Images/Key_Point_Modify_tool_dlg.png)

    **Tip:**

    -   Use the ![](/images//Images/btn_zoom_in.png) and ![](/images//Images/btn_zoom_out.png) buttons to zoom in or out on the baseline image, respectively, to better help you visualize the locations of keypoints.
...
8.  After defining the number of active keypoints within the baseline image, click the **Browse** ![](/images//Images/btn.browse-ellipsis.01.png) button next to the **Select file to test** field to open a training image.
...
11. After finding corresponding pairs of keypoints between images, click the **Find Object** button to use these pairs to match the baseline image and the target image.
    ...
    ![](/images//Images/Key_Point_Modify_tool_dlg_matched_image.png)

12. Click **OK** .

    ![](/images//Images/Baseline_tab_after.png)
