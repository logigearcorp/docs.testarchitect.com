...
description: "TestArchitect has the facility to manage, control, view and edit project items."
weight: 2
aliases: 
    - /TA_Help/Topics/Project_items_def.html
keywords: "project items"
---
...
1.  [Test folders and test modules](/user-guide/projects-and-project-items/project-items/test-folders-and-test-modules)  
...
2.  [Data sets](/user-guide/projects-and-project-items/project-items/data-sets/)  
Data sets contain rows of values that can be executed retrieved by a test and acted on sequentially.
3.  [Test suites](/user-guide/projects-and-project-items/project-items/test-suites/)  
...
4.  [TestArchitect bugs](/user-guide/projects-and-project-items/project-items/testarchitect-bugs/)  
...
5.  [Revision control](/user-guide/projects-and-project-items/project-items/revision-control/)  
...
6.  [Name change propagation](/user-guide/projects-and-project-items/project-items/name-change-propagation)  
A TestArchitect feature that automatically updates all references to a given entity when you rename that entity.
7.  [List view](/user-guide/projects-and-project-items/project-items/list-view/)  
...
8.  [Picture checks](/user-guide/projects-and-project-items/project-items/picture-checks/)  
