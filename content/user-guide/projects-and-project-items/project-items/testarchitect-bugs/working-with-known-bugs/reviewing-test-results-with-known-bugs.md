...
keywords: "known bugs, reviewing test results, bugs"
---

Reviewing test results can assist you in determining if and when JIRA bug issues on a JIRA server should be closed.

{{<note>}} It is assumed that you are familiar with test results \(see [Test results](/user-guide/working-with-test-results/) for details\). Only sections related to known bugs are discussed.
...
![](/images/TA_Help/Images/Marking_known_bug_results_summary.png)
...
## {{< expand >}} Known Bug Summary tab {{< permerlink >}} {#concept_yht_q4x_vn__section_KBSum} 
...
![](/images/TA_Help/Images/Marking_known_bug_results_KB.png)
...
## {{< expand >}} Suggested TA bug status {{< permerlink >}} {#concept_yht_q4x_vn__section_m3b_t2l_wn} 
