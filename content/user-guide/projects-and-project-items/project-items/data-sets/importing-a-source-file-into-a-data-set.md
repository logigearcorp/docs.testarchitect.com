...
A new data set with data imported from the specified external source file appears as a node beneath the **Data** node. The [row](/automation-guide/action-based-testing-language/built-in-actions/test-support-actions/data-sets/row) actions are also automatically generated in the first column of the imported data.
