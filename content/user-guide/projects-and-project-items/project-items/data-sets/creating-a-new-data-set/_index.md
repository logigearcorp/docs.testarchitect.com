...
5.  Enter the test data. Beginning with the leftmost column, enter a [row](/TA_Automation/Topics/bia_row.html) action, followed by the data values for that row.
    ...
    ![](/images//Images/data_set_creation.png)
