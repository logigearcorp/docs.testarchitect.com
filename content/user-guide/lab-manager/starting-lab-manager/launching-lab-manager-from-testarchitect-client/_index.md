...
1.  Option 1:
    ...
    ![](/images//Images/ug_labmanager02.png)
...
2.  Option 2:
    ...
    ![](/images//Images/ug_labmanager03.png)
...
![](/images//Images/ug_labmanager04.png)
...
![](/images//Images/ug_err_utility_server_unavailable.png)
...
1.  The Repository Server Control Panel may be accessed through its icon ![](/images//Images/admin_RS_icn_RSrunning.png) in the Windows notification area \(generally on the right side of the Windows taskbar\), or through the Windows Start menu \(**Start** \> **All Programs** \> **TestArchitect** \> **Repository Server**\).
