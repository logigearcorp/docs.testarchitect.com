...
description: "Enabling the TestArchitect Automation Agent in Internet Explorer is required for testing web-based applications with TestArchitect in that browser."
weight: 1
aliases: 
    - /TA_Automation/Topics/aut_enabling_automation_agent_IE_COPY.html
keywords: "Internet Explorer, enabling TestArchitect Agent, TestArchitect Agent"
---
...
3.  On the main panel, look for the add-on named TestArchitect Automation Agent and verify that its status is Enabled. If the status is Disabled, click the **Enable** button to enable the add-on.
    ...
    ![](/images/TA_Tutorials_Sample_App/Images/ug_taextension_ie.png)
