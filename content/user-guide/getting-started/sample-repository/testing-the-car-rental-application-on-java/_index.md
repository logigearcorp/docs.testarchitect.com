...
5.  Click **Execute** ![](/images//Images/btn.TAC_toolbar.Execute.png) on the toolbar to execute the test.
...
**Next topic:**[Car Rental mobile](/TA_Tutorials_Sample_App/Topics/SR_Car_Rental_mobile_def.html)
