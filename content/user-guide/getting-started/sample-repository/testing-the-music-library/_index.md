...
4.  Select the particular Music Library test \(for example, UI functional tests\) you want to execute and click the **Execute** ![](/images//Images/btn.TAC_toolbar.Execute.png) button on the toolbar.
