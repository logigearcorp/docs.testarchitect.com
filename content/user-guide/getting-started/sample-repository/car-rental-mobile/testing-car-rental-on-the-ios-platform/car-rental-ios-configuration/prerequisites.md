...
weight: 1
aliases: 
    - /TA_Tutorials_Sample_App/Topics/SR_iOS_prerequisite.html
keywords: 
---
...
-   An approved [iOS development device](/automation-guide/application-testing/mobile-testing/testing-mobile-applications/ios-automation/setting-up-the-ios-test-environment/setting-up-ios-automation/enabling-development-mode-on-ios-device).
-   An Apple USB cable.
