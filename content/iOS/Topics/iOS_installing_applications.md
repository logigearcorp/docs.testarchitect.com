---
title: "Re-signing and installing applications on iOS {#taskzvgbm2_3n .task}"
---
...
Ensure that the basic requirements are met before re-signing and installing your applications \(see [Prerequisites](iOS_prerequisite.md) for details\).
...
**Previous topic:**[Re-signing and installing TestArchitect Agent on iOS](../../iOS/Topics/iOS_installing_TA_target_device.md)
