---
title: "Capturing iOS controls with the Interface Viewer {#taskqz1txk_3n .task}"
---
...
-   You are familiar with the Interface Viewer and the concepts involved in creating an interface \(see [The Interface Viewer](../../TA_Help/Topics/Interface_def_Viewer.md) for details\).
-   A [connection](iOS_connecting_to_host_machine.md) between your iOS device and the host machine has been established.
...
-   The [Identify button](../../TA_Help/Topics/Interface_def_Viewer_identify.md) ![](../Images/iOS_hand.png).
-   [Container classes](../../TA_Help/Topics/Interface_def_container_class.md).
-   Showing invisible [windows](../../TA_Help/Topics/Interface_def_Viewer_show_invisible_windows.md).

**Parent topic:**[iOS Automation](../../iOS/Topics/iOS_automation_def.md)

**Previous topic:**[Setting up the iOS test environment](../../iOS/Topics/iOS_setting_up_the_test_enviroment.md)

**Next topic:**[Launching an AUT](../../iOS/Topics/iOS_launching_an_AUT.md)
