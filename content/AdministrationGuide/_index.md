...
---
# Administration Guide {#Administration_guide .concept}

Learn how to set up and administrate the License Server, the Repository Server, etc.

1.  [Repository Server Management](../../TA_Administration/Topics/Repo_server_management.html)  
...
2.  [Users and passwords](../../TA_Administration/Topics/adm_users_and_passwords.html)  
...
3.  [User-defined fields](../../TA_Administration/Topics/User_defined_fields.html)  
 TestArchitect allows you to create your own custom fields for your project items, to use as you require.
4.  [Tool Profiles](../../TA_Administration/Topics/Test_tool_profile.html)  
...
5.  [License server for TestArchitect](../../TA_Administration/Topics/LS_TA_License_server.html)  
...
6.  [TestArchitect Register Server](../../TA_Administration/Topics/adm_taregserver.html)  
...
7.  [Default port numbers and port ranges](../../TA_Administration/Topics/adm_port_number_port_ranges.html)  
Default port numbers and ranges assigned by TestArchitect to its various applications, services, and other components.
8.  [Connections](../../TA_Administration/Topics/Connections.html)  
