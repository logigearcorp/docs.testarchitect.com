...
---
# Starting and stopping the server {#TA_License_server_managing_start_stop .task}
...
2.  Start the server by clicking **Start** ![](../Images/licenseserver_12.png) on the toolbar.

3.  Stop the server by clicking **Stop** ![](../Images/licenseserver_13.png) on the toolbar.
...
**Next topic:**[Changing the license server port number](../../TA_Administration/Topics/LS_TA_managing_changing_port.html)
