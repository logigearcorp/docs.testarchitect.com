...
---
# Removing licenses {#TA_revoking_license .task}
...
3.  Right-click the node, then select **Remove License**.
    ...
    **Fastpath:** Alternatively, click the **Remove License\(s\)** ![](../Images/remove_license_btn.png) button on the toolbar.

    ![](../Images/remove_license_context_menu.png)
